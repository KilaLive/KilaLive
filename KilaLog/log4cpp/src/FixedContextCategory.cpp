...
namespace log4cpp
{
    ...
    void FixedContextCategory::callAppenders(const LoggingEvent& event) throw()
    {
    ...
    void FixedContextCategory::_logUnconditionally2(Priority::Value priority, const std::string& message) throw()
    {
