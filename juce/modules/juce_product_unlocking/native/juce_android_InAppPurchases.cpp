...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD)                                                          \
    ...
    METHOD(getBuyIntent, "getBuyIntent",                                                                                     \
           "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;")                 \
    METHOD(                                                                                                                  \
        getBuyIntentExtraParams, "getBuyIntentExtraParams",                                                                  \
        "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;") \
    ...
    METHOD(getPurchaseHistory, "getPurchaseHistory",                                                                         \
           "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;")
...
#undef JNI_CLASS_MEMBERS
    ...
    struct ServiceConnection : public AndroidInterfaceImplementer
    {
        ...
        jobject invoke(jobject proxy, jobject method, jobjectArray args) override
        {
            ...
            {
                onServiceConnected(env->GetObjectArrayElement(args, 0), env->GetObjectArrayElement(args, 1));
                return nullptr;
            }
    ...
    //==============================================================================
    struct InAppPurchases::Pimpl : private AsyncUpdater, private ServiceConnection
    {
            ...
            : owner(parent)
        {
            ...
            android.activity.callBooleanMethod(JuceAppActivity.bindService, intent, serviceConnection.get(),
                                               1 /*BIND_AUTO_CREATE*/);

            if (threadPool == nullptr) threadPool = new ThreadPool(1);
        }
        ...
        //==============================================================================
        bool isInAppPurchasesSupported()
        {
            return isInAppPurchasesSupported(inAppBillingService);
        }
        ...
        void getProductsInformation(const StringArray& productIdentifiers)
        {
            ...
            threadPool->addJob(new GetProductsInformationJob(*this, getPackageName(), productIdentifiers, callback), true);
        }

        void purchaseProduct(const String& productIdentifier, bool isSubscription, const StringArray& subscriptionIdentifiers,
                             bool creditForUnusedSubscription)
        {
            ...
            auto buyIntentBundle =
                getBuyIntentBundle(productIdentifier, isSubscription, subscriptionIdentifiers, creditForUnusedSubscription);
            auto* env = getEnv();
            ...
            if (responseCode == 0)
            {
                ...
                auto pendingIntent   = LocalRef<jobject>(
                    env->CallObjectMethod(buyIntentBundle.get(), JavaBundle.getParcelable, buyIntentString.get()));

                auto requestCode = 1001;
                auto intentSender =
                    LocalRef<jobject>(env->CallObjectMethod(pendingIntent.get(), AndroidPendingIntent.getIntentSender));
            ...
            {
                // Item already bought.
                notifyAboutPurchaseResult({{}, productIdentifier, juceString(getPackageName()), {}, {}}, true,
        ...
        void restoreProductsBoughtList(bool, const juce::String&)
        {
            ...
            threadPool->addJob(new GetProductsBoughtJob(*this, getPackageName(), callback), true);
        }
        ...
        void consumePurchase(const String& productIdentifier, const String& purchaseToken)
        {
            ...
            threadPool->addJob(new ConsumePurchaseJob(*this, getPackageName(), productIdentifier, purchaseToken, callback),
                               true);
        }
                                             ...
                                             const StringArray& subscriptionIdentifiers, bool creditForUnusedSubscription)
        {
            ...
            auto skuList = LocalRef<jobject>(
                env->NewObject(JavaArrayList, JavaArrayList.constructor, (int)subscriptionIdentifiers.size()));
            ...
            env->CallVoidMethod(extraParams.get(), JavaBundle.putBoolean, replaceSkusProrationString.get(),
                                creditForUnusedSubscription);

            return LocalRef<jobject>(inAppBillingService.callObjectMethod(
                IInAppBillingService.getBuyIntentExtraParams, 6, getPackageName().get(), skuString.get(),
                productTypeString.get(), devString.get(), extraParams.get()));
        }

        //==============================================================================
        void notifyAboutPurchaseResult(const InAppPurchases::Purchase& purchase, bool success,
                                       const String& statusDescription)
        {
        ...
        bool checkIsReady()
        {
            ...
            for (auto retries = 0; retries < 10 && inAppBillingService.get() == 0; ++retries) Thread::sleep(500);
        ...
        static bool isInAppPurchasesSupported(jobject iapService)
        {
            if (iapService != nullptr)
            {
                ...
                if (env->CallIntMethod(iapService, IInAppBillingService.isBillingSupported, 3, getPackageName().get(),
                                       inAppString.get())
                    != 0)
                    return false;
        ...
        void onServiceConnected(jobject, jobject iBinder) override
        {
            ...
            LocalRef<jobject> iapService(
                env->CallStaticObjectMethod(IInAppBillingServiceStub, IInAppBillingServiceStub.asInterface, iBinder));

            if (isInAppPurchasesSupported(iapService)) inAppBillingService = GlobalRef(iapService);
        ...
        struct GetProductsInformationJob : public ThreadPoolJob
        {
            ...
            GetProductsInformationJob(Pimpl& parent, const LocalRef<jstring>& packageNameToUse,
                                      const StringArray& productIdentifiersToUse, const Callback& callbackToUse)
            ...
            ThreadPoolJob::JobStatus runJob() override
            {
                ...
                if (owner.checkIsReady())
                {
                    ...
                    for (auto i = 0; i < productIdentifiers.size(); ++i)
                    {
                        ...
                        {
                            auto inAppProducts =
                                processRetrievedProducts(queryProductsInformationFromService(identifiersToUse, "inapp"));
                            auto subsProducts =
                                processRetrievedProducts(queryProductsInformationFromService(identifiersToUse, "subs"));
        ...
        private:
            LocalRef<jobject> queryProductsInformationFromService(const StringArray& productIdentifiersToQuery,
                                                                  const String&      productType)
            {
                auto* env = getEnv();

                auto skuList = LocalRef<jobject>(
                    env->NewObject(JavaArrayList, JavaArrayList.constructor, productIdentifiersToQuery.size()));

                if (skuList.get() == 0) return LocalRef<jobject>(0);
                ...
                if (querySkus.get() == 0) return LocalRef<jobject>(0);
                ...
                auto productDetails = LocalRef<jobject>(owner.inAppBillingService.callObjectMethod(
                    IInAppBillingService.getSkuDetails, 3, (jstring)packageName.get(), productTypeString.get(),
                    querySkus.get()));
            ...
            Array<InAppPurchases::Product> processRetrievedProducts(LocalRef<jobject> retrievedProducts)
            {
                ...
                if (owner.checkIsReady())
                {
                    ...
                    auto responseCode =
                        env->CallIntMethod(retrievedProducts.get(), JavaBundle.getInt, responseCodeString.get());

                    if (responseCode == 0)
                    {
                        auto detailsListString = javaString("DETAILS_LIST");

                        auto responseList = LocalRef<jobject>(env->CallObjectMethod(
                            retrievedProducts.get(), JavaBundle.getStringArrayList, detailsListString.get()));

                        if (responseList != 0)
                        {
                            auto iterator =
                                LocalRef<jobject>(env->CallObjectMethod(responseList.get(), JavaArrayList.iterator));
                            ...
                            if (iterator.get() != 0)
                            {
                                for (;;)
                                {
                                    ...
                                    auto response =
                                        juce::LocalRef<jstring>((jstring)env->CallObjectMethod(iterator, JavaIterator.next));
                                    ...
                                    if (response.get() != 0)
                                    {
                                        ...
                                        if (DynamicObject* object = responseData.getDynamicObject())
                                        {
                                            ...
                                            products.add({productId.toString(), title.toString(), description.toString(),
                                                          price.toString(), priceCurrencyCode.toString()});
                                        }
                                    }
                                }
                            }
        ...
        struct GetProductsBoughtJob : public ThreadPoolJob
        {
            ...
            GetProductsBoughtJob(Pimpl& parent, const LocalRef<jstring>& packageNameToUse, const Callback& callbackToUse)
            ...
            ThreadPoolJob::JobStatus runJob() override
            {
                ...
                if (owner.checkIsReady())
                {
                    ...
                    for (const auto& purchase : inAppPurchases) purchases.add({purchase, {}});

                    if (callback) callback({true, purchases, "Success"});
                }
                else
                {
                    if (callback) callback({false, {}, "In-App purchases unavailable"});
                }
        ...
        private:
            Array<InAppPurchases::Purchase> getProductsBought(const String& productType, jstring continuationToken)
            {
                ...
                auto productTypeString = javaString(productType);
                auto ownedItems        = LocalRef<jobject>(owner.inAppBillingService.callObjectMethod(
                    IInAppBillingService.getPurchases, 3, (jstring)packageName.get(), productTypeString.get(),
                    continuationToken));
                ...
                if (ownedItems.get() != 0)
                {
                    ...
                    if (responseCode == 0)
                    {
                        ...
                        auto ownedSkus = LocalRef<jobject>(
                            env->CallObjectMethod(ownedItems.get(), JavaBundle.getStringArrayList, itemListString.get()));
                        auto purchaseDataList = LocalRef<jobject>(
                            env->CallObjectMethod(ownedItems.get(), JavaBundle.getStringArrayList, dataListString.get()));
                        auto signatureList        = LocalRef<jobject>(env->CallObjectMethod(
                            ownedItems.get(), JavaBundle.getStringArrayList, signatureListString.get()));
                        auto newContinuationToken = LocalRef<jstring>((jstring)env->CallObjectMethod(
                            ownedItems.get(), JavaBundle.getString, continuationTokenString.get()));
                        ...
                        for (auto i = 0; i < env->CallIntMethod(purchaseDataList.get(), JavaArrayList.size); ++i)
                        {
                            ...
                            auto purchaseData =
                                juceString((jstring)(env->CallObjectMethod(purchaseDataList.get(), JavaArrayList.get, i)));
                            auto signature =
                                juceString((jstring)(env->CallObjectMethod(signatureList.get(), JavaArrayList.get, i)));
                            ...
                            if (auto* object = responseData.getDynamicObject())
                            {
                                ...
                                static const Identifier orderIdIdentifier("orderId"), packageNameIdentifier("packageName"),
                                    productIdIdentifier("productId"), purchaseTimeIdentifier("purchaseTime"),
                                ...
                                String purchaseTimeString =
                                    Time(purchaseTime.toString().getLargeIntValue()).toString(true, true, true, true);
                                purchases.add({orderId.toString(), productId.toString(), appPackageName.toString(),
                                               purchaseTimeString, purchaseToken.toString()});
                            }
                        }

                        if (newContinuationToken.get() != 0) getProductsBought(productType, newContinuationToken.get());
                    }
                }
        ...
        public:
            ...
            ConsumePurchaseJob(Pimpl& parent, const LocalRef<jstring>& packageNameToUse, const String& productIdentifierToUse,
                               const String& purchaseTokenToUse, const Callback& callbackToUse)
            ...
            ThreadPoolJob::JobStatus runJob() override
            {
                ...
                if (owner.checkIsReady())
                {
                    auto token = (!purchaseToken.isEmpty() ? purchaseToken
                                                           : getPurchaseTokenForProductId(productIdentifier, false, 0));

                    if (token.isEmpty())
                    {
                        if (callback) callback({false, productIdentifier, NEEDS_TRANS("Item not owned")});

                        return jobHasFinished;
                    }

                    auto responseCode = owner.inAppBillingService.callIntMethod(
                        IInAppBillingService.consumePurchase, 3, (jstring)packageName.get(), javaString(token).get());

                    if (callback) callback({responseCode == 0, productIdentifier, statusCodeToUserString(responseCode)});
                }
                else
                {
                    if (callback) callback({false, {}, "In-App purchases unavailable"});
        ...
        private:
            String getPurchaseTokenForProductId(const String productIdToLookFor, bool isSubscription,
                                                jstring continuationToken)
            {
                auto productTypeString = javaString(isSubscription ? "subs" : "inapp");
                auto ownedItems        = LocalRef<jobject>(owner.inAppBillingService.callObjectMethod(
                    IInAppBillingService.getPurchases, 3, (jstring)packageName.get(), productTypeString.get(),
                ...
                if (ownedItems.get() != 0)
                {
                    ...
                    if (responseCode == 0)
                    {
                        ...
                        if (newContinuationToken.get() != 0)
                            return getPurchaseTokenForProductId(productIdToLookFor, isSubscription,
                                                                newContinuationToken.get());
                    }
                }
        ...
        void handleAsyncUpdate() override
        {
...

            {
                ...
                for (int i = getProductsBoughtJobResults.size(); --i >= 0;)
                {
                    ...
                    owner.listeners.call([&](Listener& l) {
                        l.purchasesListRestored(result.purchases, result.success, result.statusDescription);
                    });
...

            {
                ...
                for (int i = consumePurchaseJobResults.size(); --i >= 0;)
                {
                    ...
                    owner.listeners.call([&](Listener& l) {
                        l.productConsumed(result.productIdentifier, result.success, result.statusDescription);
                    });
        ...
        static void inAppPurchaseCompleted(jobject intentData)
        {
            ...
            auto pd = LocalRef<jstring>(
                (jstring)env->CallObjectMethod(intentData, AndroidIntent.getStringExtra, inAppPurchaseDataString.get()));
            auto sig = LocalRef<jstring>(
                (jstring)env->CallObjectMethod(intentData, AndroidIntent.getStringExtra, inAppDataSignatureString.get()));
            ...
            if (auto* object = responseData.getDynamicObject())
            {
                ...
                static const Identifier orderIdIdentifier("orderId"), packageNameIdentifier("packageName"),
                    productIdIdentifier("productId"), purchaseTimeIdentifier("purchaseTime"),
                    purchaseTokenIdentifier("purchaseToken"), developerPayloadIdentifier("developerPayload");
        ...
        static Pimpl* getPimplFromDeveloperExtraData(const String& developerExtra)
        {
            ...
            if (DynamicObject::Ptr developerData = JSON::fromString(developerExtra).getDynamicObject())
            {
                ...
                if (hexAddr.startsWith("0x")) hexAddr = hexAddr.fromFirstOccurrenceOf("0x", false, false);

                auto* target = reinterpret_cast<Pimpl*>(static_cast<pointer_sized_int>(hexAddr.getHexValue64()));

                if (getInAppPurchaseInstances().contains(target)) return target;
            }
        ...
        static String statusCodeToUserString(int statusCode)
        {
            ...
            {
            case 0:
                return NEEDS_TRANS("Success");
            case 1:
                return NEEDS_TRANS("Cancelled by user");
            case 2:
                return NEEDS_TRANS("Service unavailable");
            case 3:
                return NEEDS_TRANS("Billing unavailable");
            case 4:
                return NEEDS_TRANS("Item unavailable");
            case 5:
                return NEEDS_TRANS("Internal error");
            case 6:
                return NEEDS_TRANS("Generic error");
            case 7:
                return NEEDS_TRANS("Item already owned");
            case 8:
                return NEEDS_TRANS("Item not owned");
            default:
                jassertfalse;
                return NEEDS_TRANS("Unknown status");
            }
        }
        ...
        CriticalSection getProductsInformationJobResultsLock, getProductsBoughtJobResultsLock, consumePurchaseJobResultsLock;
