...
namespace juce
{
    ...
    */
    class JUCE_API OnlineUnlockForm : public Component, private Button::Listener
    {
    public:
        ...
        */
        OnlineUnlockForm(OnlineUnlockStatus&, const String& userInstructions, bool hasCancelButton = true,
