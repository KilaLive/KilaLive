    ...
    */
    ...
    protected:
        ...
        /** Creates an MemoryMappedAudioFormatReader object.
            ...
            been mapped.
        */
        MemoryMappedAudioFormatReader(const File& file, const AudioFormatReader& details, int64 dataChunkStart,
                                      int64 dataChunkLength, int bytesPerFrame);
    ...
    protected:
        ...
        Range<float> scanMinAndMaxInterleaved(int channel, int64 startSampleInFile, int64 numSamples) const noexcept
        {
            ...
            return SourceType(addBytesToPointer(sampleToPointer(startSampleInFile), ((int)bitsPerSample / 8) * channel),
                              (int)numChannels)
