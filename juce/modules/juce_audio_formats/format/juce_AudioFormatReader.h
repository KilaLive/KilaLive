...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        ...
        /** Reads samples from the stream.
            ...
            @param fillLeftoverChannelsWithCopies   if true, this indicates that if there's no source data available
                                        ...
                                        the second would be cleared. If there are many channels, e.g. you try to read 4
           channels from a stereo file, then the last 3 would all end up with copies of the same data.
            ...
            @see readMaxLevels
        */
        bool read(int* const* destSamples, int numDestChannels, int64 startSampleInSource, int numSamplesToRead,
        ...
        /** Fills a section of an AudioBuffer from this reader.
            ...
            and the buffer.
        */
        void read(AudioBuffer<float>* buffer, int startSampleInDestBuffer, int numSamples, int64 readerStartSample,
        ...
        */
        ...
        /** Finds the highest and lowest sample levels from a section of the audio stream.
            ...
            @see read
        */
        virtual void readMaxLevels(int64 startSample, int64 numSamples, float& lowestLeft, float& highestLeft,
        ...
        */
        int64 searchForLevel(int64 startSample, int64 numSamplesToSearch, double magnitudeRangeMinimum,
        ...
        */
        virtual bool readSamples(int** destSamples, int numDestChannels, int startOffsetInDestBuffer, int64 startSampleInFile,
                                 int numSamples) = 0;
    ...
    protected:
        ...
        struct ReadHelper
        {
            typedef AudioData::Pointer<DestSampleType, AudioData::NativeEndian, AudioData::NonInterleaved,
                                       AudioData::NonConst>
                DestType;
            typedef AudioData::Pointer<SourceSampleType, SourceEndianness, AudioData::Interleaved, AudioData::Const>
                SourceType;

            template <typename TargetType>
            static void read(TargetType* const* destData, int destOffset, int numDestChannels, const void* sourceData,
                ...
                for (int i = 0; i < numDestChannels; ++i)
                {
                    if (void* targetChan = destData[i])
                    {
                        ...
                        if (i < numSourceChannels)
                            dest.convertSamples(SourceType(addBytesToPointer(sourceData, i * SourceType::getBytesPerSample()),
                                                           numSourceChannels),
                                                numSamples);
                        else
        ...
        */
        static void clearSamplesBeyondAvailableLength(int** destSamples, int numDestChannels, int startOffsetInDestBuffer,
                                                      int64 startSampleInFile, int& numSamples, int64 fileLengthInSamples)
        {
