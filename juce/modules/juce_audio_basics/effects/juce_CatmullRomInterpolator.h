...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        int process(double speedRatio, const float* inputSamples, float* outputSamples,
        ...
        /** Resamples a stream of samples.
            ...
            @returns the actual number of input samples that were used
        */
        int process(double speedRatio, const float* inputSamples, float* outputSamples, int numOutputSamplesToProduce,
        ...
        /** Resamples a stream of samples, adding the results to the output data
            ...
            @returns the actual number of input samples that were used
        */
        int processAdding(double speedRatio, const float* inputSamples, float* outputSamples, int numOutputSamplesToProduce,
                          float gain) noexcept;
        ...
        */
        int processAdding(double speedRatio, const float* inputSamples, float* outputSamples, int numOutputSamplesToProduce,
                          int available, int wrapAround, float gain) noexcept;
