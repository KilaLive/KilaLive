...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        virtual void startNote(int midiNoteNumber, float velocity, SynthesiserSound* sound,
    ...
    */
    ...
    public:
        ...
        */
        ...
        /** Sends a midi controller message to any active voices.
            ...
            @param controllerValue      the midi controller value, between 0 and 127, as returned by
        ...
        */
        inline void renderNextBlock(AudioBuffer<float>& outputAudio, const MidiBuffer& inputMidi, int startSample,
                                    int numSamples)
        {
            processNextBlock(outputAudio, inputMidi, startSample, numSamples);
        }

        inline void renderNextBlock(AudioBuffer<double>& outputAudio, const MidiBuffer& inputMidi, int startSample,
                                    int numSamples)
        {
            processNextBlock(outputAudio, inputMidi, startSample, numSamples);
        }
    ...
    protected:
        ...
        */
        virtual SynthesiserVoice* findFreeVoice(SynthesiserSound* soundToPlay, int midiChannel, int midiNoteNumber,
        ...
        */
        void startVoice(SynthesiserVoice* voice, SynthesiserSound* sound, int midiChannel, int midiNoteNumber,
                        float velocity);
    ...
    private:
        ...
        void processNextBlock(AudioBuffer<floatType>& outputAudio, const MidiBuffer& inputMidi, int startSample,
                              int numSamples);
        //==============================================================================
        double     sampleRate                  = 0;
