...
namespace juce
{
    namespace
    {
        void checkAndLimitZoneParameters(int minValue, int maxValue, int& valueToCheckAndLimit) noexcept
        {
    ...
    //==============================================================================
    MPEZone::MPEZone(int masterChannel_, int numNoteChannels_, int perNotePitchbendRange_, int masterPitchbendRange_) noexcept
    ...
    {
        if (masterChannel == other.masterChannel) return true;

        if (masterChannel > other.masterChannel) return other.overlapsWith(*this);
    ...
    bool MPEZone::truncateToFit(MPEZone other) noexcept
    {
        ...
        if (masterChannelDiff < 2) return false;
    ...
    {
        return masterChannel == other.masterChannel && numNoteChannels == other.numNoteChannels
               && perNotePitchbendRange == other.perNotePitchbendRange && masterPitchbendRange == other.masterPitchbendRange;
    }
...
//==============================================================================
    ...
    public:
        MPEZoneTests()
            : UnitTest("MPEZone class", "MIDI/MPE")
        {
        }
    ...
    private:
        //==============================================================================
        void testOverlapsWith(int masterChannelFirst, int numNoteChannelsFirst, int masterChannelSecond,
                              int numNoteChannelsSecond, bool expectedRetVal)
        {
        ...
        //==============================================================================
        void testTruncateToFit(int masterChannelFirst, int numNoteChannelsFirst, int masterChannelSecond,
                               int numNoteChannelsSecond, bool expectedRetVal, int masterChannelFirstAfter,
                               int numNoteChannelsFirstAfter)
        {
            MPEZone first(masterChannelFirst, numNoteChannelsFirst);
            MPEZone second(masterChannelSecond, numNoteChannelsSecond);
