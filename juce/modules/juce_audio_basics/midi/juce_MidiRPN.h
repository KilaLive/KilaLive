...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        bool parseControllerMessage(int midiChannel, int controllerNumber, int controllerValue,
    ...
    */
    ...
    public:
        ...
        */
        static MidiBuffer generate(int channel, int parameterNumber, int value, bool isNRPN = false,
