...
namespace juce
{
    ...
    {
        for (auto channel : c) addChannel(channel);
    }
    ...
    {
        if (type >= discreteChannel0) return "Discrete " + String(type - discreteChannel0 + 1);
    ...
    {
        if (type >= discreteChannel0) return String(type - discreteChannel0 + 1);
        ...
        if (type >= ambisonicACN4 && type <= ambisonicACN35) return "ACN" + String(type - ambisonicACN4 + 4);
    ...
    AudioChannelSet::ChannelType AudioChannelSet::getChannelTypeFromAbbreviation(const String& abbr)
    {
        if (abbr.length() > 0 && (abbr[0] >= '0' && abbr[0] <= '9'))
            return static_cast<AudioChannelSet::ChannelType>(static_cast<int>(discreteChannel0) + abbr.getIntValue() + 1);
    ...
    String AudioChannelSet::getSpeakerArrangementAsString() const
    {
        ...
        for (auto& speaker : getChannelTypes())
        {
            ...
            if (name.isNotEmpty()) speakerTypes.add(name);
        }
    ...
    AudioChannelSet AudioChannelSet::fromAbbreviatedString(const String& str)
    {
        ...
        for (auto& abbr : StringArray::fromTokens(str, true))
        {
            ...
            if (type != unknown) set.addChannel(type);
        }
    ...
    {
        for (auto& speaker : getChannelTypes())
            if (speaker <= ambisonicACN35) return false;
    ...
    AudioChannelSet::ChannelType AudioChannelSet::getTypeOfChannel(int index) const noexcept
    {
        ...
        for (int i = 0; i < index && bit >= 0; ++i) bit = channels.findNextSetBit(bit + 1);
    ...
    {
        return AudioChannelSet((1u << left) | (1u << right) | (1u << centre) | (1u << LFE) | (1u << leftSurround)
                               | (1u << rightSurround));
    }
    ...
    {
        return AudioChannelSet((1u << left) | (1u << right) | (1u << centre) | (1u << LFE) | (1u << leftSurround)
                               | (1u << rightSurround) | (1u << centreSurround));
    }
    AudioChannelSet AudioChannelSet::create6point0Music()
    {
        return AudioChannelSet((1u << left) | (1u << right) | (1u << leftSurround) | (1u << rightSurround)
                               | (1u << leftSurroundSide) | (1u << rightSurroundSide));
    }
    AudioChannelSet AudioChannelSet::create6point1Music()
    {
        return AudioChannelSet((1u << left) | (1u << right) | (1u << LFE) | (1u << leftSurround) | (1u << rightSurround)
                               | (1u << leftSurroundSide) | (1u << rightSurroundSide));
    }
    AudioChannelSet AudioChannelSet::create7point0()
    {
        return AudioChannelSet((1u << left) | (1u << right) | (1u << centre) | (1u << leftSurroundSide)
                               | (1u << rightSurroundSide) | (1u << leftSurroundRear) | (1u << rightSurroundRear));
    }
    AudioChannelSet AudioChannelSet::create7point0SDDS()
    {
        return AudioChannelSet((1u << left) | (1u << right) | (1u << centre) | (1u << leftSurround) | (1u << rightSurround)
                               | (1u << leftCentre) | (1u << rightCentre));
    }
    AudioChannelSet AudioChannelSet::create7point1()
    {
        return AudioChannelSet((1u << left) | (1u << right) | (1u << centre) | (1u << LFE) | (1u << leftSurroundSide)
                               | (1u << rightSurroundSide) | (1u << leftSurroundRear) | (1u << rightSurroundRear));
    }
    ...
    {
        return AudioChannelSet((1u << left) | (1u << right) | (1u << centre) | (1u << leftSurroundRear)
                               | (1u << rightSurroundRear));
    }
    AudioChannelSet AudioChannelSet::hexagonal()
    {
        return AudioChannelSet((1u << left) | (1u << right) | (1u << centre) | (1u << centreSurround)
                               | (1u << leftSurroundRear) | (1u << rightSurroundRear));
    }
    AudioChannelSet AudioChannelSet::octagonal()
    {
        return AudioChannelSet((1u << left) | (1u << right) | (1u << centre) | (1u << leftSurround) | (1u << rightSurround)
                               | (1u << centreSurround) | (1u << wideLeft) | (1u << wideRight));
    }
    AudioChannelSet AudioChannelSet::create7point0point2()
    {
        return AudioChannelSet((1u << left) | (1u << right) | (1u << centre) | (1u << leftSurroundSide)
                               | (1u << rightSurroundSide) | (1u << leftSurroundRear) | (1u << rightSurroundRear)
                               | (1u << topSideLeft) | (1u << topSideRight));
    }
    ...
    AudioChannelSet AudioChannelSet::ambisonic(int order)
    {
        ...
        if (order == 0) return AudioChannelSet((uint32)(1 << ambisonicACN0));
    ...
    int AudioChannelSet::getAmbisonicOrder() const
    {
        ...
        if (ambisonicOrder >= 0) return (*this == ambisonic(ambisonicOrder) ? ambisonicOrder : -1);
    ...
    Array<AudioChannelSet> AudioChannelSet::channelSetsWithNumberOfChannels(int numChannels)
    {
        ...
        if (numChannels != 0)
        {
            ...
            if (order >= 0) retval.add(AudioChannelSet::ambisonic(order));
        }
    ...
    {
        if (channels.getHighestBit() > topRearRight) return -1;
...
//==============================================================================
    ...
    public:
        AudioChannelSetUnitTest()
            : UnitTest("AudioChannelSetUnitTest", "Audio")
        {
        }
        ...
        void runTest() override
        {
            ...
            beginTest("channelSetsWithNumberOfChannels returns correct speaker count");
            {
                for (auto ch = 1; ch <= max; ++ch)
                {
                    ...
                    for (auto set : channelSets) expect(set.size() == ch);
                }
            }
            ...
            beginTest("Ambisonics");
            {
                ...
                mask |= (1ull << AudioChannelSet::ambisonicACN1) | (1ull << AudioChannelSet::ambisonicACN2)
                        | (1ull << AudioChannelSet::ambisonicACN3);
                checkAmbisonic(mask, 1, "1st Order Ambisonics");

                mask |= (1ull << AudioChannelSet::ambisonicACN4) | (1ull << AudioChannelSet::ambisonicACN5)
                        | (1ull << AudioChannelSet::ambisonicACN6) | (1ull << AudioChannelSet::ambisonicACN7)
                        | (1ull << AudioChannelSet::ambisonicACN8);
                checkAmbisonic(mask, 2, "2nd Order Ambisonics");

                mask |= (1ull << AudioChannelSet::ambisonicACN9) | (1ull << AudioChannelSet::ambisonicACN10)
                        | (1ull << AudioChannelSet::ambisonicACN11) | (1ull << AudioChannelSet::ambisonicACN12)
                        | (1ull << AudioChannelSet::ambisonicACN13) | (1ull << AudioChannelSet::ambisonicACN14)
                        | (1ull << AudioChannelSet::ambisonicACN15);
                checkAmbisonic(mask, 3, "3rd Order Ambisonics");

                mask |= (1ull << AudioChannelSet::ambisonicACN16) | (1ull << AudioChannelSet::ambisonicACN17)
                        | (1ull << AudioChannelSet::ambisonicACN18) | (1ull << AudioChannelSet::ambisonicACN19)
                        | (1ull << AudioChannelSet::ambisonicACN20) | (1ull << AudioChannelSet::ambisonicACN21)
                        | (1ull << AudioChannelSet::ambisonicACN22) | (1ull << AudioChannelSet::ambisonicACN23)
                        | (1ull << AudioChannelSet::ambisonicACN24);
                checkAmbisonic(mask, 4, "4th Order Ambisonics");

                mask |= (1ull << AudioChannelSet::ambisonicACN25) | (1ull << AudioChannelSet::ambisonicACN26)
                        | (1ull << AudioChannelSet::ambisonicACN27) | (1ull << AudioChannelSet::ambisonicACN28)
                        | (1ull << AudioChannelSet::ambisonicACN29) | (1ull << AudioChannelSet::ambisonicACN30)
                        | (1ull << AudioChannelSet::ambisonicACN31) | (1ull << AudioChannelSet::ambisonicACN32)
                        | (1ull << AudioChannelSet::ambisonicACN33) | (1ull << AudioChannelSet::ambisonicACN34)
    ...
    private:
        void checkAmbisonic(uint64 mask, int order, const char* layoutName)
        {
            ...
            for (auto layout : layouts) expect(layout.getAmbisonicOrder() == (layout == expected ? order : -1));
        }
        ...
        static AudioChannelSet channelSetFromMask(uint64 mask)
        {
            ...
            for (int bit = 0; bit <= 62; ++bit)
                if ((mask & (1ull << bit)) != 0) channels.add(static_cast<AudioChannelSet::ChannelType>(bit));
