...
{
    //==============================================================================
    void JUCE_CALLTYPE attachSubWindow(void* hostWindow, int& titleW, int& titleH, Component* comp)
    {
        RECT clientRect;
    ...
    void JUCE_CALLTYPE resizeHostWindow(void* hostWindow, int& titleW, int& titleH, Component* comp)
    {
        ...
        SetWindowPos((HWND)hostWindow, 0, 0, 0, borderW + jmax(titleW, comp->getWidth()),
                     borderH + comp->getHeight() + titleH, SWP_NOACTIVATE | SWP_NOMOVE | SWP_NOZORDER | SWP_NOOWNERZORDER);
    }
    ...
    extern "C" BOOL WINAPI DllMain(HINSTANCE instance, DWORD reason, LPVOID reserved)
    {
        ...
        if (GetModuleHandleA("DAE.DLL") != 0) return DllMainRTAS(instance, reason, reserved);
