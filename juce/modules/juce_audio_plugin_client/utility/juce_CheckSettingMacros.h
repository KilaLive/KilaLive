...
#if !(JucePlugin_Build_VST || JucePlugin_Build_VST3 || JucePlugin_Build_AU || JucePlugin_Build_AUv3 || JucePlugin_Build_RTAS \
      || JucePlugin_Build_AAX || JucePlugin_Build_Standalone || JucePlugin_Build_LV2)
...
#error                                                                                                                       \
    "JucePlugin_Latency is now deprecated - instead, call the AudioProcessor::setLatencySamples() method if your plugin has a non-zero delay"
#endif
