...
namespace juce
{
    ...
    */
    class StandalonePluginHolder : private AudioIODeviceCallback, private Timer
    {
    public:
        //==============================================================================
        struct PluginInOuts
        ...
        */
            ...
            , autoOpenMidiDevices(shouldAutoOpenMidiDevices)
        {
            ...
            if (preferredSetupOptions != nullptr) options = new AudioDeviceManager::AudioDeviceSetup(*preferredSetupOptions);
                                    ...
                                    const AudioDeviceManager::AudioDeviceSetup* preferredSetupOptions)
        {
            ...
            deviceManager.initialise(enableAudioInput ? totalInChannels : 0, totalOutChannels, savedState, true,
    ...
    private:
                                   ...
                                   int numOutputChannels, int numSamples) override
        {
            ...
            player.audioDeviceIOCallback(inputChannelData, numInputChannels, outputChannelData, numOutputChannels,
                                         numSamples);
        }
        ...
        void timerCallback() override
        {
            ...
            if (newMidiDevices != lastMidiDevices)
            {
                for (auto& oldDevice : lastMidiDevices)
                    if (!newMidiDevices.contains(oldDevice)) deviceManager.setMidiInputEnabled(oldDevice, false);

                for (auto& newDevice : newMidiDevices)
                    if (!lastMidiDevices.contains(newDevice)) deviceManager.setMidiInputEnabled(newDevice, true);
            }
        }
    ...
    */
    class StandaloneFilterWindow : public DocumentWindow, public Button::Listener
    {
    public:
        //==============================================================================
        ...
        */
            ...
            , optionsButton("Options")
        {
            ...
            pluginHolder = new StandalonePluginHolder(settingsToUse, takeOwnershipOfSettings, preferredDefaultDeviceName,
    ...
    private:
        ...
        private:
            ...
            void inputMutedChanged(bool newInputMutedValue)
            {
                ...
                resized();
#else
                setSize(editor->getWidth(), editor->getHeight() + (shouldShowNotification ? NotificationArea::height : 0));
#endif
            }
