    ...
    namespace dsp
    {
        ...
        public:
            SIMDRegisterUnitTests()
                : UnitTest("SIMDRegister UnitTests", "DSP")
            {
            }
                ...
                for (size_t i = 0; i < SIMDRegister<type>::SIMDNumElements; ++i)
                {
                    ...
                    if (delta > 1e-4)
                    {
                        DBG("a: " << SIMDRegister_test_internal::difference(ptr[i])
                                  << " b: " << SIMDRegister_test_internal::difference(array[i]) << " difference: " << delta);
                        return false;
                    }
                }
            ...
            static void copy(SIMDRegister<type>& vec, const type* ptr)
            {
                ...
                {
                    for (size_t i = 0; i < SIMDRegister<type>::SIMDNumElements; ++i) vec[i] = ptr[i];
                }
            }
            ...
            struct AccessTest
            {
                ...
                static void run(UnitTest& u, Random& random)
                {
                    ...
                    for (size_t i = 0; i < SIMDRegister<type>::SIMDNumElements; ++i) a[i] = array[i];
                    ...
                    for (size_t i = 0; i < SIMDRegister<type>::SIMDNumElements; ++i) u.expect(b[i] == array[i]);
                }
            };
            ...
            struct BitOperatorTests
            {
                ...
                static void run(UnitTest& u, Random& random)
                {
                    ...
                    for (int n = 0; n < 100; ++n)
                    {
                        ...
                        for (size_t i = 0; i < SIMDRegister<MaskType>::SIMDNumElements; ++i)
                        {
                            array_c[i] = Operation::template outofplace<MaskType, MaskType>(array_a[i], array_b[i]);
                        }
                        ...
                        for (size_t i = 0; i < SIMDRegister<MaskType>::SIMDNumElements; ++i)
                            array_c[i] =
                                Operation::template outofplace<MaskType, MaskType>(array_a[i], static_cast<MaskType>(9));
