...
#ifdef _MSC_VER
#define DECLARE_AVX_SIMD_CONST(type, name) static __declspec(align(32)) const type name[32 / sizeof(type)]
...
#else
#define DECLARE_AVX_SIMD_CONST(type, name) static const type name[32 / sizeof(type)] __attribute__((aligned(32)))
...
#define DEFINE_AVX_SIMD_CONST(type, class_type, name)                                                                        \
    const type SIMDNativeOps<class_type>::name[32 / sizeof(type)] __attribute__((aligned(32)))
        ...
        struct SIMDNativeOps<float>
        {
            ...
            {
                return *reinterpret_cast<const __m256*>(a);
            }
        ...
        struct SIMDNativeOps<double>
        {
            ...
            {
                return *reinterpret_cast<const __m256d*>(a);
            }
        ...
        struct SIMDNativeOps<int8_t>
        {
            ...
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE vconst(const int8_t* a) noexcept
            {
                return *reinterpret_cast<const __m256i*>(a);
            }
            ...
            {
                return _mm256_andnot_si256(a, vconst(kAllBitsSet));
            }
            ...
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE load(const int8_t* a) noexcept
            {
                ...
                return _mm256_set_epi8(b[31], b[30], b[29], b[28], b[27], b[26], b[25], b[24], b[23], b[22], b[21], b[20],
        ...
        struct SIMDNativeOps<uint8_t>
        {
            ...
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE vconst(const uint8_t* a) noexcept
            {
                return *reinterpret_cast<const __m256i*>(a);
            }
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE ssign(__m256i a) noexcept
            {
                return _mm256_xor_si256(a, vconst(kHighBit));
            }
        ...
        struct SIMDNativeOps<int16_t>
        {
            ...
            //==============================================================================
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE vconst(const int16_t* a) noexcept
            {
                return *reinterpret_cast<const __m256i*>(a);
            }
            ...
            {
                return _mm256_set_epi16(a[15], a[14], a[13], a[12], a[11], a[10], a[9], a[8], a[7], a[6], a[5], a[4], a[3],
                                        a[2], a[1], a[0]);
            }
        ...
        struct SIMDNativeOps<uint16_t>
        {
            ...
            //==============================================================================
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE vconst(const uint16_t* a) noexcept
            {
                return *reinterpret_cast<const __m256i*>(a);
            }
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE ssign(__m256i a) noexcept
            ...
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE load(const uint16_t* a) noexcept
            {
                ...
                return _mm256_set_epi16(b[15], b[14], b[13], b[12], b[11], b[10], b[9], b[8], b[7], b[6], b[5], b[4], b[3],
                                        b[2], b[1], b[0]);
            }
        ...
        struct SIMDNativeOps<int32_t>
        {
            ...
            //==============================================================================
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE vconst(const int32_t* a) noexcept
            {
                return *reinterpret_cast<const __m256i*>(a);
            }
        ...
        struct SIMDNativeOps<uint32_t>
        {
            ...
            //==============================================================================
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE vconst(const uint32_t* a) noexcept
            {
                return *reinterpret_cast<const __m256i*>(a);
            }
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE ssign(__m256i a) noexcept
        ...
        struct SIMDNativeOps<int64_t>
        {
            ...
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE vconst(const int64_t* a) noexcept
            {
                return *reinterpret_cast<const __m256i*>(a);
            }
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE add(__m256i a, __m256i b) noexcept
            ...
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE mul(__m256i a, __m256i b) noexcept
            {
                ...
                for (int i = 0; i < 4; ++i) dst[i] = aptr[i] * bptr[i];
        ...
        struct SIMDNativeOps<uint64_t>
        {
            ...
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE vconst(const uint64_t* a) noexcept
            {
                return *reinterpret_cast<const __m256i*>(a);
            }
            static forcedinline __m256i JUCE_VECTOR_CALLTYPE ssign(__m256i a) noexcept
