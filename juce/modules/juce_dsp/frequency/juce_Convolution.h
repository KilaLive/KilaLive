    ...
    namespace dsp
    {
        ...
        */
        ...
        public:
            ...
            */
            void loadImpulseResponse(const void* sourceData, size_t sourceDataSize, bool wantsStereo, bool wantsTrimming,
                                     size_t size, bool wantsNormalization = true);
            ...
            /** This function loads an impulse response from an audio file on any drive. It
                ...
                @param wantsNormalization       requests to normalize the impulse response amplitude
            */
            void loadImpulseResponse(const File& fileImpulseResponse, bool wantsStereo, bool wantsTrimming, size_t size,
            ...
            /** This function loads an impulse response from an audio buffer, which is
                ...
                @param size                     the expected size for the impulse response after loading, can be
                                                set to 0 for requesting maximum original impulse response size
            */
            void copyAndLoadImpulseResponseFromBuffer(AudioBuffer<float>& buffer, double bufferSampleRate, bool wantsStereo,
                                                      bool wantsTrimming, bool wantsNormalization, size_t size);
            ...
            */
            void copyAndLoadImpulseResponseFromBlock(AudioBlock<float> block, double bufferSampleRate, bool wantsStereo,
                                                     bool wantsTrimming, bool wantsNormalization, size_t size);
