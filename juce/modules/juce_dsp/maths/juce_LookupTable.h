        ...
        public:
            ...
            */
            ...
            /** Initialises or changes the parameters of a LookupTableTransform object.
                ...
                @param numPoints             The number of pre-calculated values stored.
            */
            void initialise(const std::function<FloatType(FloatType)>& functionToApproximate, FloatType minInputValueToUse,
                            FloatType maxInputValueToUse, size_t numPoints);
            ...
            */
            ...
            {
                for (size_t i = 0; i < numSamples; ++i) output[i] = processSampleUnchecked(input[i]);
            }
            ...
            */
            ...
            {
                for (size_t i = 0; i < numSamples; ++i) output[i] = processSample(input[i]);
            }
