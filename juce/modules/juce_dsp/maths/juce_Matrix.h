        ...
        */
        ...
        public:
            ...
            */
            ...
            void clear() noexcept
            {
                zeromem(data.begin(), sizeof(ElementType) * (size_t)data.size());
            }
            ...
            inline ElementType operator()(size_t row, size_t column) const noexcept
            {
                ...
                return data.getReference(static_cast<int>(dataAcceleration.getReference(static_cast<int>(row)))
            ...
            */
            ...
            static inline Matrix hadarmard(const Matrix& a, const Matrix& b)
            {
                Matrix result(a);
                result.hadarmard(b);
                return result;
        ...
        private:
            ...
            void resize()
            {
                ...
                for (size_t i = 0; i < rows; ++i) dataAcceleration.setUnchecked(static_cast<int>(i), i * columns);
            }
