    ...
    namespace dsp
    {
        ...
        namespace ProcessorHelpers  // Internal helper classes used in building the ProcessorChain
        {
            ...
            struct GetterHelper
            {
                ...
                static auto& get(ProcessorType& a) noexcept
                {
                    return GetterHelper<arg - 1>::get(a.processors);
                }
            };
            ...
            struct ChainBase
            {
                ...
                auto& get() noexcept
                {
                    return GetterHelper<arg>::get(getThis());
                }
            };
            ...
            struct Chain : public ChainBase<FirstProcessor, Chain<FirstProcessor, SubsequentProcessors...>>
            {
                ...
                void process(ProcessContext& context) noexcept
                {
                    ...
                    if (context.usesSeparateInputAndOutputBlocks())
                    {
                        ...
                        ProcessContextReplacing<typename ProcessContext::SampleType> replacingContext(
