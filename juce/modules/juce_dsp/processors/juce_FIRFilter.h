            ...
            */
            ...
            public:
                ...
                */
                ...
                Filter(Coefficients<NumericType>* coefficientsToUse)
                    : coefficients(coefficientsToUse)
                {
                    reset();
                }
                ...
                */
                void reset()
                {
                    if (coefficients != nullptr)
                    {
                        ...
                        for (size_t i = 0; i < size; ++i) fifo[i] = SampleType{0};
                    }
                }
                ...
                */
                ...
                void process(const ProcessContext& context) noexcept
                {
                    ...
                    for (size_t i = 0; i < numSamples; ++i) dst[i] = processSingleSample(src[i], fifo, fir, size, p);
            ...
            private:
                                                                           ...
                                                                           size_t& p) noexcept
                {
                    ...
                    size_t k;
                    for (k = 0; k < m - p; ++k) out += buf[(p + k)] * fir[k];

                    for (size_t j = 0; j < p; ++j) out += buf[j] * fir[j + k];
            ...
            struct Coefficients : public ProcessorState
            {
                ...
                */
                ...
                /** Returns the magnitude frequency response of the filter for a given frequency array
                    and sample rate.
                */
                void getMagnitudeForFrequencyArray(double* frequencies, double* magnitudes, size_t numSamples,
