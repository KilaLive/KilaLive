            ...
            */
            ...
            struct Coefficients : public ProcessorState
            {
                ...
                */
                ...
                Coefficients(NumericType b0, NumericType, NumericType b2, NumericType b3, NumericType a0, NumericType a1,
                ...
                */
                ...
                /** Returns the coefficients for a low-pass shelf filter with variable Q and gain.
                    ...
                    attenuate them.
                */
                static Ptr makeLowShelf(double sampleRate, NumericType cutOffFrequency, NumericType Q,
                ...
                /** Returns the coefficients for a high-pass shelf filter with variable Q and gain.
                    ...
                    attenuate them.
                */
                static Ptr makeHighShelf(double sampleRate, NumericType cutOffFrequency, NumericType Q,
                                         NumericType gainFactor);
                ...
                */
                static Ptr makePeakFilter(double sampleRate, NumericType centreFrequency, NumericType Q,
                                          NumericType gainFactor);
                ...
                */
                ...
                /** Returns the magnitude frequency response of the filter for a given frequency array
                    and sample rate.
                */
                void getMagnitudeForFrequencyArray(const double* frequencies, double* magnitudes, size_t numSamples,
                ...
                */
                ...
                /** Returns the phase frequency response of the filter for a given frequency array
                    and sample rate.
                */
                void getPhaseForFrequencyArray(double* frequencies, double* phases, size_t numSamples,
                                               double sampleRate) const noexcept;
