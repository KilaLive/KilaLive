        ...
        */
        ...
        struct ProcessorDuplicator
        {
            ...
            void process(const ProcessContext& context) noexcept
            {
                ...
                auto numChannels = static_cast<size_t>(
                    jmin(context.getInputBlock().getNumChannels(), context.getOutputBlock().getNumChannels()));
        ...
        private:
            ...
            struct MonoProcessContext : public ProcessContext
            {
                MonoProcessContext(const ProcessContext& multiChannelContext, size_t channelToUse)
                    : ProcessContext(multiChannelContext)
                ...
                typename ProcessContext::AudioBlockType getInputBlock() const noexcept
                {
