...
namespace juce
{
    namespace dsp
    {
        ...
        void LadderFilter<Type>::setMode(Mode newValue) noexcept
        {
            ...
            {
            case Mode::LPF12:
                A    = {{Type(0), Type(0), Type(1), Type(0), Type(0)}};
                comp = Type(0.5);
                break;
            case Mode::HPF12:
                A    = {{Type(1), Type(-2), Type(1), Type(0), Type(0)}};
                comp = Type(0);
                break;
            case Mode::LPF24:
                A    = {{Type(0), Type(0), Type(0), Type(0), Type(1)}};
                comp = Type(0.5);
                break;
            case Mode::HPF24:
                A    = {{Type(1), Type(-4), Type(6), Type(-4), Type(1)}};
                comp = Type(0);
                break;
            default:
                jassertfalse;
        ...
        {
            for (auto& s : state) s.fill(Type(0));
