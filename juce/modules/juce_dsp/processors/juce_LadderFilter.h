        ...
        */
        ...
        public:
            ...
            /** Sets the resonance of the filter.
                @param newValue a value between 0 and 1; higher values increase the resonance and can result in self
               oscillation! */
            void setResonance(Type newValue) noexcept;

            /** Sets the amound of saturation in the filter.
                @param newValue saturation amount; it can be any number greater than or equal to one. Higher values result in
               more distortion.*/
        ...
        private:
            ...
            {
                cutoffTransformSmoother.setValue(std::exp(cutoffFreqHz * cutoffFreqScaler));
            }
            void updateResonance() noexcept
            {
                scaledResonanceSmoother.setValue(jmap(resonance, Type(0.1), Type(1.0)));
            }
        };
