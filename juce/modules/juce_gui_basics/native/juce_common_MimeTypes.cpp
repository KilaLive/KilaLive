...
namespace juce
{
    ...
    static StringArray getMimeTypesForFileExtension(const String& fileExtension)
    {
        ...
        for (auto type : MimeTypeTableEntry::table)
            if (fileExtension == type.fileExtension) result.add(type.mimeType);
    ...
    static StringArray filterMimeTypes(const StringArray& mimeTypes, const String& filter)
    {
        ...
        if (filterToUse.isEmpty() || filterToUse == "/") return mimeTypes;

        StringArray result;

        for (const auto& type : mimeTypes)
            if (String(type).contains(filterToUse)) result.add(type);
    ...
    static String getCommonMimeType(const StringArray& mimeTypes)
    {
        ...
        {
            if (mimeTypes[i] == commonMime) continue;
            ...
            if (!mimeTypes[i].startsWith(commonMime)) return "*/*";
        }
    ...
    //==============================================================================
    MimeTypeTableEntry MimeTypeTableEntry::table[640] = {{"3dm", "x-world/x-3dmf"},
                                                         {"3dmf", "x-world/x-3dmf"},
