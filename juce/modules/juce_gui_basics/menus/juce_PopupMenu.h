...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        ...
        /** Adds an item that represents one of the commands in a command manager object.
            ...
            @param iconToUse            an optional Drawable object to use as the icon to the left of the item.
                                        ...
                                        delete it later when no longer needed
        */
        void addCommandItem(ApplicationCommandManager* commandManager, CommandID commandID,
                            const String& displayName = String(), Drawable* iconToUse = nullptr);
        ...
        */
        void addColouredItem(int itemResultID, const String& itemText, Colour itemTextColour, bool isEnabled = true,
                             bool isTicked = false, const Image& iconToUse = Image());
        ...
        /** Appends a text item with a special colour.
            ...
            current look-and-feel. See addItem() for a description of the parameters.
        */
        void addColouredItem(int itemResultID, const String& itemText, Colour itemTextColour, bool isEnabled, bool isTicked,
                             Drawable* iconToUse);
        ...
        */
        void addCustomItem(int itemResultID, Component* customComponent, int idealWidth, int idealHeight,
                           bool triggerMenuItemAutomaticallyWhenClicked, const PopupMenu* optionalSubMenu = nullptr);
        ...
        */
        ...
        /** Appends a sub-menu with an icon.
            ...
            clicked to trigger it as a command.
        */
        void addSubMenu(const String& subMenuName, const PopupMenu& subMenu, bool isEnabled, const Image& iconToUse,
                        bool isTicked = false, int itemResultID = 0);
        ...
        */
        void addSubMenu(const String& subMenuName, const PopupMenu& subMenu, bool isEnabled, Drawable* iconToUse,
                        bool isTicked = false, int itemResultID = 0);
        ...
        */
        ...
        /** Displays the menu at a specific location.
            ...
            @see show()
        */
        int showAt(Rectangle<int> screenAreaToAttachTo, int itemIDThatMustBeVisible = 0, int minimumWidth = 0,
        ...
        */
        int showAt(Component* componentToAttachTo, int itemIDThatMustBeVisible = 0, int minimumWidth = 0,
                   int maximumNumColumns = 0, int standardItemHeight = 0,
                   ModalComponentManager::Callback* callback = nullptr);
        ...
        */
        class JUCE_API CustomComponent : public Component, public SingleThreadedReferenceCountedObject
        {
        public:
        ...
        */
        struct JUCE_API LookAndFeelMethods
        {
            ...
            virtual void drawPopupMenuItem(Graphics&, const Rectangle<int>& area, bool isSeparator, bool isActive,
                                           bool isHighlighted, bool isTicked, bool hasSubMenu, const String& text,
                                           const String& shortcutKeyText, const Drawable* icon, const Colour* textColour) = 0;
            ...
            virtual void getIdealPopupMenuItemSize(const String& text, bool isSeparator, int standardMenuItemHeight,
                                                   int& idealWidth, int& idealHeight) = 0;
            ...
            virtual void drawMenuBarItem(Graphics&, int width, int height, int itemIndex, const String& itemText,
                                         bool isMouseOverItem, bool isMenuOpen, bool isMouseOverBar, MenuBarComponent&) = 0;
    ...
    private:
        ...
        int drawPopupMenuItem(Graphics&, int, int, bool, bool, bool, bool, bool, const String&, const String&, Image*,
                              const Colour*)
        {
            return 0;
        }
