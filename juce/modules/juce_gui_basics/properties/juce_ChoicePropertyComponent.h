...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        ChoicePropertyComponent(const Value& valueToControl, const String& propertyName, const StringArray& choices,
        ...
        /** Creates the component using a ValueWithDefault object. This will add an item to the ComboBox for the
            ...
            @param valueToControl       the ValueWithDefault object that contains the Value object that the combo box will
           read and control
            @param propertyName         the name of the property
            @param choices              the list of possible values that the drop-down list will contain
            @param correspondingValues  a list of values corresponding to each item in the 'choices' StringArray.
        ...
        */
        ChoicePropertyComponent(ValueWithDefault valueToControl, const String& propertyName, const StringArray& choices,
                                const Array<var>& correspondingValues);
        ...
        */
        ChoicePropertyComponent(ValueWithDefault valueToControl, const String& propertyName);
