...
{
    //==============================================================================
    class ChoicePropertyComponent::RemapperValueSource : public Value::ValueSource, private Value::Listener
    {
    public:
        ...
        var getValue() const override
        {
            ...
            for (auto& map : mappings)
                if (map.equalsWithSameType(targetValue)) return mappings.indexOf(map) + 1;
        ...
        void setValue(const var& newValue) override
        {
            ...
            if (!remappedVal.equalsWithSameType(sourceValue)) sourceValue = remappedVal;
        }
    ...
    //==============================================================================
    class ChoicePropertyComponent::RemapperValueSourceWithDefault : public Value::ValueSource, private Value::Listener
    {
    public:
        ...
        var getValue() const override
        {
            if (valueWithDefault.isUsingDefault()) return -1;
        ...
        void setValue(const var& newValue) override
        {
            ...
            else
            {
                ...
                if (!remappedVal.equalsWithSameType(sourceValue)) valueWithDefault = remappedVal;
            }
        }
    ...
    ChoicePropertyComponent::ChoicePropertyComponent(const String& name, const StringArray& choiceList,
    ...
    ChoicePropertyComponent::ChoicePropertyComponent(const Value& valueToControl, const String& name,
                                                     const StringArray& choiceList, const Array<var>& correspondingValues)
    ...
    ChoicePropertyComponent::ChoicePropertyComponent(ValueWithDefault valueToControl, const String& name,
                                                     const StringArray& choiceList, const Array<var>& correspondingValues)
        : ChoicePropertyComponent(name, choiceList, correspondingValues)
    {
        ...
        comboBox.getSelectedIdAsValue().referTo(
            Value(new RemapperValueSourceWithDefault(valueToControl, correspondingValues)));
    }
        ...
        , choices({"Enabled", "Disabled"})
    {
        ...
        comboBox.getSelectedIdAsValue().referTo(Value(new RemapperValueSourceWithDefault(valueToControl, {true, false})));
    }
    ...
    void ChoicePropertyComponent::changeIndex()
    {
        if (isCustomClass)
        {
            ...
            if (newIndex != getIndex()) setIndex(newIndex);
        }
    }
