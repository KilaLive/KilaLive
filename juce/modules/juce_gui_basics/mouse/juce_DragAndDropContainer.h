...
namespace juce
{
    ...
    */
        ...
        */
        ...
        /** Begins a drag-and-drop operation.
            ...
            @param inputSourceCausingDrag            the mouse input source which started the drag. When calling
                                                     ...
                                                     are several dragging mouse input sources (which can often occur on
           mobile) then JUCE will use the mouseInputSource which is closest to the sourceComponent.
        */
        void startDragging(const var& sourceDescription, Component* sourceComponent, Image dragImage = Image(),
                           bool allowDraggingToOtherJuceWindows = false, const Point<int>* imageOffsetFromMouse = nullptr,
    ...
    private:
        ...
        const MouseInputSource* getMouseInputSourceForDrag(Component*              sourceComponent,
        ...
        JUCE_DEPRECATED_WITH_BODY(virtual bool shouldDropFilesWhenDraggedExternally(const String&, Component*, StringArray&,
                                                                                    bool&),
                                  { return false; })
