    ...
    public:
        ...
        */
        enum ColourIds
        {
            ...
            dragAndDropIndicatorColourId =
                0x1000502, /**< The colour to use for the drag-and-drop target position indicator. */
            selectedItemBackgroundColourId =
                0x1000503,                 /**< The colour to use to fill the background of any selected items. */
        ...
        */
        struct JUCE_API LookAndFeelMethods
        {
            ...
            virtual void drawTreeviewPlusMinusBox(Graphics&, const Rectangle<float>& area, Colour backgroundColour,
                                                  bool isItemOpen, bool isMouseOver) = 0;
