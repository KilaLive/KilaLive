...
namespace juce
{
        ...
        , downButton({}, DrawableButton::ImageOnButtonBackground)
    {
        ...
        addButton.setConnectedEdges(Button::ConnectedOnLeft | Button::ConnectedOnRight | Button::ConnectedOnBottom
                                    | Button::ConnectedOnTop);

        addAndMakeVisible(removeButton);
        removeButton.onClick = [this] { deleteSelected(); };
        removeButton.setConnectedEdges(Button::ConnectedOnLeft | Button::ConnectedOnRight | Button::ConnectedOnBottom
                                       | Button::ConnectedOnTop);
    ...
    {
        if (rowIsSelected) g.fillAll(findColour(TextEditor::highlightColourId));
    ...
    void FileSearchPathListComponent::addPath()
    {
        ...
        if (chooser.browseForDirectory()) path.add(chooser.getResult(), listBox.getSelectedRow());
