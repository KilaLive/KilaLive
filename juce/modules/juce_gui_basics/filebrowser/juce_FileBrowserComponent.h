...
namespace juce
{
    ...
    */
    class JUCE_API FileBrowserComponent : public Component, private FileBrowserListener, private FileFilter, private Timer
    {
    public:
        //==============================================================================
        ...
        */
        enum FileChooserFlags
        {
            ...
            warnAboutOverwriting =
                128, /**< specifies that the dialog should warn about overwriting existing files (if possible). */
        ...
        */
        FileBrowserComponent(int flags, const File& initialFileOrDirectory, const FileFilter* fileFilter,
        ...
        */
        struct JUCE_API LookAndFeelMethods
        {
            ...
            virtual void drawFileBrowserRow(Graphics&, int width, int height, const File& file, const String& filename,
                                            Image* optionalIcon, const String& fileSizeDescription,
                                            const String& fileTimeDescription, bool isDirectory, bool isItemSelected,
                                            int itemIndex, DirectoryContentsDisplayComponent&) = 0;
            ...
            virtual void layoutFileBrowserComponent(FileBrowserComponent&              browserComp,
                                                    ...
                                                    TextEditor* filenameBox, Button* goUpButton) = 0;
        };
        ...
        */
        enum ColourIds
        {
            currentPathBoxBackgroundColourId =
                0x1000640, /**< The colour to use to fill the background of the current path ComboBox. */
            ...
            filenameBoxBackgroundColourId =
                0x1000643,                      /**< The colour to use to fill the background of the filename TextEditor. */
