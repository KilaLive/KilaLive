...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        FileChooser(const String& dialogBoxTitle, const File& initialFileOrDirectory = File(),
                    const String& filePatternsAllowed = String(), bool useOSNativeDialogBox = true,
        ...
        */
        void launchAsync(int                   flags, std::function<void(const FileChooser&)>,
