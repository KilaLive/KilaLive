...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        void shareFiles(const Array<URL>& files, std::function<void(bool /*success*/, const String& /*error*/)> callback);
        ...
        /** Shares the given text.
            ...
            succeeded. Also, the optional error message is always empty on Android.
        */
        void shareText(const String& text, std::function<void(bool /*success*/, const String& /*error*/)> callback);
        ...
        /** A convenience function to share an image. This is useful when you have images
            ...
            succeeded. Also, the optional error message is always empty on Android.
        */
        void shareImages(const Array<Image>& images, std::function<void(bool /*success*/, const String& /*error*/)> callback,
        ...
        /** A convenience function to share arbitrary data. The data will be written
            ...
            succeeded. Also, the optional error message is always empty on Android.
        */
        void shareData(const MemoryBlock& mb, std::function<void(bool /*success*/, const String& /*error*/)> callback);
