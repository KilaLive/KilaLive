...
namespace juce
{
    ...
    void ComponentBoundsConstrainer::setMinimumHeight(int minimumHeight) noexcept
    {
        minH = minimumHeight;
    }
    ...
    void ComponentBoundsConstrainer::setSizeLimits(int minimumWidth, int minimumHeight, int maximumWidth,
    ...
    void ComponentBoundsConstrainer::setMinimumOnscreenAmounts(int minimumWhenOffTheTop, int minimumWhenOffTheLeft,
    ...
    void ComponentBoundsConstrainer::setBoundsForComponent(Component* component, Rectangle<int> targetBounds,
                                                           ...
                                                           bool isStretchingBottom, bool isStretchingRight)
    {
        ...
        {
            if (auto* peer = component->getPeer()) border = peer->getFrameSize();
        ...
        checkBounds(bounds, border.addedTo(component->getBounds()), limits, isStretchingTop, isStretchingLeft,
    ...
    {
        setBoundsForComponent(component, component->getBounds(), false, false, false, false);
    }
    ...
    //==============================================================================
    void ComponentBoundsConstrainer::checkBounds(Rectangle<int>& bounds, const Rectangle<int>& old,
                                                 const Rectangle<int>& limits, bool isStretchingTop, bool isStretchingLeft,
                                                 bool isStretchingBottom, bool isStretchingRight)
    {
        if (isStretchingLeft)
        ...
        if (aspectRatio > 0.0)
        {
            ...
            {
                if (isStretchingLeft) bounds.setX(old.getRight() - bounds.getWidth());

                if (isStretchingTop) bounds.setY(old.getBottom() - bounds.getHeight());
            }
        }
