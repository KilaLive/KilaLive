    ...
    struct GridTests : public juce::UnitTest
    {
        ...
        void runTest() override
        {
...

            {
                ...
                grid.items.addArray({GridItem().withArea(1, 1), GridItem().withArea(2, 1)});
                ...
                grid.items.addArray({GridItem().withArea(1, 2), GridItem().withArea(2, 2), GridItem().withArea(3, 1),
...

            {
                ...
                grid.templateRows.addArray({Tr(1_fr), Tr(20_px)});
...

            {
                ...
                grid.templateRows    = {Tr(50_px), Tr(1_fr), Tr(50_px)};

                grid.templateAreas = {"header header header header", "main main . sidebar", "footer footer footer footer"};

                grid.items.addArray({
                    GridItem().withArea("header"),
...

            {
                ...
                grid.templateAreas = {"header header header header header", "main main . sidebar sidebar",
                                      "footer footer footer footer footer", "sub sub sub sub sub"};
...

            {
                ...
                grid.items.addArray({GridItem().withArea("header"), GridItem().withArea("main"),
                                     GridItem().withArea("sidebar"), GridItem().withArea("footer"),
