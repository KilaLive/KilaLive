    ...
    */
    ...
    public:
        ...
        struct Px final
        {
            ...
            explicit constexpr Px(long double p)
                : pixels(p)
            {
            }
            explicit constexpr Px(unsigned long long p)
                : pixels(static_cast<long double>(p))
            {
            }
        ...
        struct Fr final
        {
            ...
            explicit constexpr Fr(unsigned long long p)
                : fraction(p)
            {
            }
        ...
        struct TrackInfo final
        {
            ...
            /** */
            TrackInfo(const juce::String& startLineNameToUse, Fr fractionOfFreeSpace,
