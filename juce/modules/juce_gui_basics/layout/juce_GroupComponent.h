...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        GroupComponent(const String& componentName = String(), const String& labelText = String());
        ...
        */
        ...
        struct JUCE_API LookAndFeelMethods
        {
            ...
            virtual void drawGroupComponentOutline(Graphics&, int w, int h, const String& text, const Justification&,
                                                   GroupComponent&) = 0;
        };
