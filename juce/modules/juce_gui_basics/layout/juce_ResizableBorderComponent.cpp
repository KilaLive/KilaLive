...
namespace juce
{
    ...
    ResizableBorderComponent::Zone& ResizableBorderComponent::Zone::operator=(
        const ResizableBorderComponent::Zone& other) noexcept
    {
        zone = other.zone;
        return *this;
    }
                                                                                        ...
                                                                                        Point<int>             position)
    {
        ...
        if (totalSize.contains(position) && !border.subtractedFrom(totalSize).contains(position))
        {
    ...
    void ResizableBorderComponent::mouseDrag(const MouseEvent& e)
    {
        ...
        {
            constrainer->setBoundsForComponent(component, newBounds, mouseZone.isDraggingTopEdge(),
                                               mouseZone.isDraggingLeftEdge(), mouseZone.isDraggingBottomEdge(),
    ...
    {
        return x < borderSize.getLeft() || x >= getWidth() - borderSize.getRight() || y < borderSize.getTop()
