...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        ...
        TargetClass* findParentComponentOfClass() const
        {
            for (auto* p = parentComponent; p != nullptr; p = p->parentComponent)
                if (auto* target = dynamic_cast<TargetClass*>(p)) return target;
        ...
        */
        Image createComponentSnapshot(Rectangle<int> areaToGrab, bool clipImageToComponentBounds = true,
        ...
        */
        void enterModalState(bool takeKeyboardFocus = true, ModalComponentManager::Callback* callback = nullptr,
    ...
    private:
        ...
        void       internalMouseUp(MouseInputSource, Point<float>, Time, const ModifierKeys oldModifiers, float, float, float,
                                   float, float);
