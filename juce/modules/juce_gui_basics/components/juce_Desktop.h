...
namespace juce
{
    ...
    */
    class JUCE_API Desktop : private DeletedAtShutdown, private Timer, private AsyncUpdater
    {
    public:
        //==============================================================================
        ...
        */
        ...
        enum DisplayOrientation
        {
            ...
            rotatedAntiClockwise =
                8, /**< Indicates that the device is turned 90 degrees anti-clockwise from its upright position. */
