    ...
    */
    ...
    public:
        ...
        */
        ...
        JUCE_DEPRECATED(void setContentComponent(Component* newContentComponent, bool deleteOldOne = true,
        ...
        */
        struct JUCE_API LookAndFeelMethods
        {
            ...
            virtual void drawResizableWindowBorder(Graphics&, int w, int h, const BorderSize<int>& border,
                                                   ResizableWindow&)                                                      = 0;
        };
    ...
    private:
        ...
        bool ownsContentComponent = false, resizeToFitContent = false, fullscreen = false, canDrag = true,
             dragStarted = false;
