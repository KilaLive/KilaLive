...
namespace juce
{
    ...
    */
    class JUCE_API Button : public Component, public SettableTooltipClient
    {
    protected:
        //==============================================================================
        /** Creates a button.
    ...
    public:
        ...
        */
        void setRepeatSpeed(int initialDelayInMillisecs, int repeatDelayInMillisecs,
        ...
        */
        struct JUCE_API LookAndFeelMethods
        {
            ...
            virtual void drawButtonBackground(Graphics&, Button&, const Colour& backgroundColour, bool isMouseOverButton,
                                              bool isButtonDown) = 0;
            ...
            virtual void drawTickBox(Graphics&, Component&, float x, float y, float w, float h, bool ticked, bool isEnabled,
        ...
        private:
            ...
            virtual int getTextButtonFont(TextButton&)
            {
                return 0;
            }
