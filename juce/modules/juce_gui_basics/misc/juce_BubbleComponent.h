...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        void setPosition(Rectangle<int> rectangleToPointTo, int distanceFromTarget = 15, int arrowLength = 10);
        ...
        */
        ...
        struct JUCE_API LookAndFeelMethods
        {
            ...
            virtual void drawBubble(Graphics&, BubbleComponent&, const Point<float>& positionOfTip,
