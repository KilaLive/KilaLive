    ...
    namespace BlocksProtocol
    {
        ...
        */
        ...
        struct TouchPosition
        {
            ...
            enum
            {
                bits = Xcoord::bits + Ycoord::bits + Zcoord::bits
            };
        };
        ...
        struct TouchVelocity
        {
            ...
            enum
            {
                bits = VXcoord::bits + VYcoord::bits + VZcoord::bits
            };
        };
        ...
        static constexpr const char* ledProgramLittleFootFunctions[] = {"min/iii",
                                                                        "min/fff",
                                                                        "max/iii",
                                                                        "max/fff",
                                                                        "clamp/iiii",
