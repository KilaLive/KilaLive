...
namespace juce
{
    ...
    struct BlockConfigManager
    {
        ...
        struct ConfigDescription
        {
            ...
            static_assert(configMaxOptions == Block::ConfigMetaData::numOptionNames,
                          "Config options size and config metadata size should be the same");

            Block::ConfigMetaData toConfigMetaData() const
            {
                return Block::ConfigMetaData((uint32)item, value, {min, max}, isActive, name, (uint32)type,
                                             (const char**)optionNames, group);
            }
        };
        ...
        ConfigDescription configList[numConfigItems] = {
            ...
            {slideMode,
             ...
             "Slide Mode",
             ConfigType::options,
             {"Absolute", "Relative Unipolar", "Relative Bipolar"},
             "Play mode"},
            ...
            {xTrackingMode,
             ...
             "Glide Tracking Mode",
             ConfigType::options,
             {"Multi-Channel", "Last Played", "Highest", "Lowest", "Disabled"},
             "Play mode"},
            {yTrackingMode,
             1,
             0,
            ...
            {zTrackingMode,
             ...
             ConfigType::options,
             {"Multi-Channel", "Last Played", "Highest", "Lowest", "Disabled", "Hardest"},
             "Play mode"},
        ...
        int32 getItemValue(ConfigItemId item)
        {
            ...
            if (getIndexForItem(item, itemIndex)) return configList[itemIndex].value;
        ...
        void setItemValue(ConfigItemId item, int32 value)
        {
            ...
            if (getIndexForItem(item, itemIndex)) configList[itemIndex].value = value;
        ...
        int32 getItemMin(ConfigItemId item)
        {
            ...
            if (getIndexForItem(item, itemIndex)) return configList[itemIndex].min;
        ...
        void setItemMin(ConfigItemId item, int32 min)
        {
            ...
            if (getIndexForItem(item, itemIndex)) configList[itemIndex].min = min;
        }
        ...
        int32 getItemMax(ConfigItemId item)
        {
            ...
            if (getIndexForItem(item, itemIndex)) return configList[itemIndex].max;
        ...
        void setItemMax(ConfigItemId item, int32 max)
        {
            ...
            if (getIndexForItem(item, itemIndex)) configList[itemIndex].max = max;
        ...
        bool getItemActive(ConfigItemId item)
        {
            ...
            if (getIndexForItem(item, itemIndex)) return configList[itemIndex].isActive;
        ...
        void setItemActive(ConfigItemId item, bool isActive)
        {
            ...
            if (getIndexForItem(item, itemIndex)) configList[itemIndex].isActive = isActive;
        ...
        Block::ConfigMetaData getMetaData(ConfigItemId item)
        {
            ...
            if (getIndexForItem(item, itemIndex)) return configList[itemIndex].toConfigMetaData();
        ...
        {
            for (auto& i : configList) i.isActive = false;
        }
        ...
        void setBlockConfig(ConfigItemId item, int32 value)
        {
            ...
            if (deviceConnection != nullptr) deviceConnection->sendMessageToDevice(packet.getData(), (size_t)packet.size());
        }
        ...
        void handleConfigSetMessage(int32 item, int32 value)
        {
            ...
            if (getIndexForItem((ConfigItemId)item, index)) configList[index].value = value;
        }
