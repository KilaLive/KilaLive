...
namespace juce
{
    ...
    public:
        ...
        {
            if (shouldDeliver.compareAndSetBool(0, 1)) owner.handleAsyncUpdate();
        }
    ...
    AsyncUpdater::~AsyncUpdater()
    {
        ...
        jassert((!isUpdatePending()) || MessageManager::getInstanceWithoutCreating() == nullptr
    ...
    void AsyncUpdater::handleUpdateNowIfNeeded()
    {
        ...
        if (activeMessage->shouldDeliver.exchange(0) != 0) handleAsyncUpdate();
    }
