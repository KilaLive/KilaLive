...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        ...
        /** Opens a camera device.
            ...
            the frames.
        */
        static CameraDevice* openDevice(int deviceIndex, int minWidth = 128, int minHeight = 64, int maxWidth = 1024,
                                        int maxHeight = 768, bool highQuality = true);
    ...
    private:
        ...
        CameraDevice(const String& name, int index, int minWidth, int minHeight, int maxWidth, int maxHeight,
                     bool highQuality);
