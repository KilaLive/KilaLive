...
#include "../native/juce_win32_Video.h"
    ...
    File VideoComponent::getCurrentVideoFile() const
    {
        return pimpl->currentFile;
    }
    URL VideoComponent::getCurrentVideoURL() const
    {
    ...
    Rectangle<int> VideoComponent::getVideoNativeSize() const
    {
    ...
    void VideoComponent::setPlayPosition(double newPos)
    {
    ...
    void VideoComponent::setPlaySpeed(double newSpeed)
    {
        pimpl->setSpeed(newSpeed);
    }
    void VideoComponent::setAudioVolume(float newVolume)
    {
        pimpl->setVolume(newVolume);
    }
    float VideoComponent::getAudioVolume() const
    {
