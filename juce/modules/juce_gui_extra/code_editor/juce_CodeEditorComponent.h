...
namespace juce
{
    ...
    /**
        ...
        files.
    */
    class JUCE_API CodeEditorComponent : public Component, public ApplicationCommandTarget, public TextInputTarget
    {
    public:
        //==============================================================================
        ...
        */
        enum ColourIds
        {
            ...
            lineNumberBackgroundId =
                0x1004504,                /**< The colour to use for filling the background of the line-number gutter. */
