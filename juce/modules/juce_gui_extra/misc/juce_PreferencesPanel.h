    ...
    public:
        ...
        */
        ...
        /** Creates a page using a set of drawables to define the page's icon.
            ...
            @see DrawableButton
        */
        void addSettingsPage(const String& pageTitle, const Drawable* normalIcon, const Drawable* overIcon,
        ...
        */
        void showInDialogBox(const String& dialogTitle, int dialogWidth, int dialogHeight,
