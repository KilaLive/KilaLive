...
namespace juce
{
    ...
    */
    namespace LiveConstantEditor
    {
        ...
        inline void setFromString(bool& v, const String& s)
        {
            v = (s == "true");
        }
        ...
        inline String getAsString(bool v, bool)
        {
            return v ? "true" : "false";
        }
        ...
        struct LivePropertyEditor : public LivePropertyEditorBase
        {
            ...
            LivePropertyEditor(ValueType& v, CodeDocument& d)
                : LivePropertyEditorBase(v, d)
            {
        ...
        //==============================================================================
        class JUCE_API ValueList : private AsyncUpdater, private DeletedAtShutdown
        {
        public:
            ValueList();
            ~ValueList();
            ...
            LiveValue<Type>& getValue(const char* file, int line, const Type& initialValue)
            {
                ...
                for (int i = 0; i < values.size(); ++i)
                {
                    ...
                    if (v->sourceLine == line && v->sourceFile == file) return *static_cast<ValueType*>(v);
                }
...
#else
#define JUCE_LIVE_CONSTANT(initialValue) (initialValue)
#endif
