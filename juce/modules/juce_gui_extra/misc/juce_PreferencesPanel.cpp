...
namespace juce
{
                                           ...
                                           const Drawable* downIcon)
    {
        ...
        if (currentPage == nullptr) setCurrentPage(title);
    }
    ...
    //==============================================================================
    void PreferencesPanel::showInDialogBox(const String& dialogTitle, int dialogWidth, int dialogHeight,
    ...
    void PreferencesPanel::resized()
    {
        ...
        if (currentPage != nullptr) currentPage->setBounds(getLocalBounds().withTop(buttonSize + 5));
    }
