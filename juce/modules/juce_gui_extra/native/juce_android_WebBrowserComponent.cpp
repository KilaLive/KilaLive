...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD)                                                          \
    ...
    METHOD(loadDataWithBaseURL, "loadDataWithBaseURL",                                                                       \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD) METHOD(constructor, "<init>", "()V")
...
#undef JNI_CLASS_MEMBERS
    ...
    //==============================================================================
    class WebBrowserComponent::Pimpl : public AndroidViewComponent, public AsyncUpdater
    {
    public:
            ...
            : owner(o)
        {
            ...
            juceWebChromeClient =
                GlobalRef(LocalRef<jobject>(env->NewObject(JuceWebChromeClient, JuceWebChromeClient.constructor,
                                                           android.activity.get(), reinterpret_cast<jlong>(&owner))));
            env->CallVoidMethod((jobject)getView(), AndroidWebView.setWebChromeClient, juceWebChromeClient.get());

            juceWebViewClient = GlobalRef(LocalRef<jobject>(env->NewObject(
                JuceWebViewClient, JuceWebViewClient.constructor, android.activity.get(), reinterpret_cast<jlong>(&owner))));
        ...
        ~Pimpl()
        {
            ...
            auto defaultChromeClient =
                LocalRef<jobject>(env->NewObject(AndroidWebChromeClient, AndroidWebChromeClient.constructor));
            auto defaultViewClient =
                LocalRef<jobject>(env->NewObject(AndroidWebViewClient, AndroidWebViewClient.constructor));
        ...
        void goToURL(const String& url, const StringArray* headers, const MemoryBlock* postData)
        {
            ...
            {
                auto headersMap =
                    LocalRef<jobject>(env->NewObject(JavaHashMap, JavaHashMap.constructorWithCapacity, headers->size()));
                ...
                for (const auto& header : *headers)
                {
                    ...
                    env->CallObjectMethod(headersMap, JavaMap.put, javaString(name).get(), javaString(value).get());
                }

                env->CallVoidMethod((jobject)getView(), AndroidWebView.loadUrl, javaString(url).get(), headersMap.get());
            }
            else if (headers == nullptr && postData != nullptr)
            {
                auto dataStringJuce = postData->toString();
                auto dataStringJava = javaString(dataStringJuce);
                auto encodingString = LocalRef<jobject>(env->CallStaticObjectMethod(
                    URLEncoder, URLEncoder.encode, dataStringJava.get(), javaString("utf-8").get()));

                auto bytes = LocalRef<jbyteArray>((jbyteArray)env->CallObjectMethod(encodingString, JavaString.getBytes));

                env->CallVoidMethod((jobject)getView(), AndroidWebView.postUrl, javaString(url).get(), bytes.get());
            }
            else if (headers != nullptr && postData != nullptr)
            {
        ...
        void handleAsyncUpdate()
        {
            ...
            if (connectionThread == nullptr) return;
            ...
            if (result.statusCode >= 200 && result.statusCode < 300)
            {
                ...
                getEnv()->CallVoidMethod((jobject)getView(), AndroidWebView.loadDataWithBaseURL, url.get(), data.get(),
                                         mimeType.get(), encoding.get(), 0);
            }
            else
            {
        ...
        {
            if (MessageManager::getInstance()->isThisTheMessageThread()) return owner.pageAboutToLoad(url);

            WeakReference<Pimpl> weakRef(this);

            if (weakRef == nullptr) return false;
    ...
    private:
        ...
        public:
            ...
            ConnectionThread(Pimpl& ownerToUse, URL& url, const StringArray& headers)
    ...
    //==============================================================================
    void WebBrowserComponent::goToURL(const String& url, const StringArray* headers, const MemoryBlock* postData)
    {
        lastURL = url;
    ...
    void WebBrowserComponent::clearCookies()
    {
        ...
        auto cookieManager =
            LocalRef<jobject>(env->CallStaticObjectMethod(AndroidCookieManager, AndroidCookieManager.getInstance));
        ...
        {
            clearCookiesMethod =
                env->GetMethodID(AndroidCookieManager, "removeAllCookies", "(Landroid/webkit/ValueCallback;)V");
    ...
    JUCE_JNI_CALLBACK(JUCE_ANDROID_ACTIVITY_CLASSNAME, webViewPageLoadStarted, bool,
                      (JNIEnv * env, jobject /*activity*/, jlong host, jobject /*webView*/, jobject url))
    {
        setEnv(env);
    ...
    JUCE_JNI_CALLBACK(JUCE_ANDROID_ACTIVITY_CLASSNAME, webViewPageLoadFinished, void,
                      (JNIEnv * env, jobject /*activity*/, jlong host, jobject /*webView*/, jobject url))
    {
        setEnv(env);
    ...
    JUCE_JNI_CALLBACK(JUCE_ANDROID_ACTIVITY_CLASSNAME, webViewReceivedError, void,
                      (JNIEnv * env, jobject /*activity*/, jlong host, jobject /*webView*/, jobject /*request*/,
                       jobject error))
    {
        setEnv(env);
    ...
    JUCE_JNI_CALLBACK(JUCE_ANDROID_ACTIVITY_CLASSNAME, webViewReceivedHttpError, void,
                      (JNIEnv * env, jobject /*activity*/, jlong host, jobject /*webView*/, jobject /*request*/,
    ...
    JUCE_JNI_CALLBACK(JUCE_ANDROID_ACTIVITY_CLASSNAME, webViewReceivedSslError, void,
                      (JNIEnv * env, jobject /*activity*/, jlong host, jobject /*webView*/, jobject /*sslErrorHandler*/,
                       jobject sslError))
    {
        setEnv(env);
    ...
    JUCE_JNI_CALLBACK(JUCE_ANDROID_ACTIVITY_CLASSNAME, webViewCloseWindowRequest, void,
                      (JNIEnv * env, jobject /*activity*/, jlong host, jobject /*webView*/))
    {
        setEnv(env);
    ...
    JUCE_JNI_CALLBACK(JUCE_ANDROID_ACTIVITY_CLASSNAME, webViewCreateWindowRequest, void,
                      (JNIEnv * env, jobject /*activity*/, jlong host, jobject /*webView*/))
    {
        setEnv(env);
