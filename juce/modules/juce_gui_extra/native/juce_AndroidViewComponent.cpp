...
namespace juce
{
    ...
    public:
        Pimpl(jobject v, Component& comp)
            ...
            , owner(comp)
        {
            if (owner.isShowing()) componentPeerChanged();
        }
        ...
        void componentMovedOrResized(bool /*wasMoved*/, bool /*wasResized*/) override
        {
            ...
            if (topComp->getPeer() != nullptr)
            {
                ...
                getEnv()->CallVoidMethod(view, AndroidView.layout, r.getX(), r.getY(), r.getRight(), r.getBottom());
            }
        }
    ...
    void AndroidViewComponent::setView(void* view)
    {
        if (view != getView())
        {
            ...
            if (view != nullptr) pimpl.reset(new Pimpl((jobject)view, *this));
        }
    }
    ...
    {
        if (pimpl != nullptr) setBounds(pimpl->getViewBounds());
    }
