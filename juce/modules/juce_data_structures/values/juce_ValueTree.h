    ...
    public:
        ...
        */
        ...
        /** Creates a value tree from nested lists of properties and ValueTrees.
            ...
            @endverbatim
        */
        ValueTree(const Identifier& type, std::initializer_list<std::pair<Identifier, var>> properties,
        ...
        */
        ...
        public:
            ...
            */
            virtual void valueTreeChildOrderChanged(ValueTree& parentTreeWhoseChildrenHaveMoved, int oldIndex,
                                                    int newIndex) = 0;
        ...
        */
        ...
        /** Changes a named property of the tree, but will not notify a specified listener of the change.
            @see setProperty
        */
        ValueTree& setPropertyExcludingListener(Listener* listenerToExclude, const Identifier& name, const var& newValue,
