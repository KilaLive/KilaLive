...
namespace juce
{
    ...
    */
    ...
    template <typename Type>
    inline void CachedValue<Type>::referToWithDefault(ValueTree& v, const Identifier& i, UndoManager* um,
    ...
    {
        if (changedProperty == targetProperty && targetTree == changedTree) forceUpdateOfCachedValue();
    }
