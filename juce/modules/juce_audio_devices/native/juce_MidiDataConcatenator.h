            ...
            while (numBytes > 0)
            {
                ...
                else
                {
                    ...
                    while (numBytes > 0)
                    {
                        ...
                        {
                            if (len == 0 && *d < 0x80 && runningStatus >= 0x80) data[len++] = runningStatus;
                            ...
                            if (len >= MidiMessage::getMessageLengthFromFirstByte(firstByte)) break;
                        }
                    }
                    ...
                    if (len > 0)
                    {
                        ...
                        if (used <= 0) break;  // malformed message..
