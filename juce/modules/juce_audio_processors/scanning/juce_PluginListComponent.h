...
namespace juce
{
    ...
    */
    class JUCE_API PluginListComponent : public Component, public FileDragAndDropTarget, private ChangeListener
    {
    public:
        //==============================================================================
        /**
        ...
        */
        PluginListComponent(AudioPluginFormatManager& formatManager, KnownPluginList& listToRepresent,
                            const File& deadMansPedalFile, PropertiesFile* propertiesToUse,
        ...
        void setTheDefaultPath(String& defaultPath);
        ...
        */
        ...
        void scanFor(AudioPluginFormat&, const StringArray& filesOrIdentifiersToScan, const String& defaultSearchPath);
