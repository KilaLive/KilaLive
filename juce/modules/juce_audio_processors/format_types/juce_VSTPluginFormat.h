...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        static AudioPluginInstance* createCustomVSTFromMainCall(void* entryPointFunction, double initialSampleRate,
        ...
        */
        ...
        static pointer_sized_int JUCE_CALLTYPE dispatcher(AudioPluginInstance*, int32, int32, pointer_sized_int, void*,
                                                          float);
