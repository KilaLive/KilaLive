...
namespace juce
{
    ...
    {
        return fileOrIdentifier == other.fileOrIdentifier && uid == other.uid;
    }

    static String getPluginDescSuffix(const PluginDescription& d)
    {
        return "-" + String::toHexString(d.fileOrIdentifier.hashCode()) + "-" + String::toHexString(d.uid);
    }
    ...
    XmlElement* PluginDescription::createXml() const
    {
        ...
        if (descriptiveName != name) e->setAttribute("descriptiveName", descriptiveName);
