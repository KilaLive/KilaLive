...
namespace juce
{
    class ProcessorParameterPropertyComp : public PropertyComponent, private AudioProcessorListener, private Timer
    {
    public:
        ...
        {
            if (parameterIndex == index) paramHasChanged = true;
        }
    ...
    private:
        ...
        {
        public:
            ParamSlider(AudioProcessor& p, int paramIndex)
                : owner(p)
                , index(paramIndex)
            {
