    ...
    */
    ...
    public:
        ...
        */
        ...
        public:
            ...
            */
            ...
            inline int getNumberOfChannels() const noexcept
            {
        ...
        */
        ...
        {
            if (auto* bus = getBus(isInput, busIndex)) return bus->getNumberOfChannels();
        ...
        */
        ...
        AudioBuffer<FloatType> getBusBuffer(AudioBuffer<FloatType>& processBlockBuffer, bool isInput, int busIndex) const
        {
            ...
            return AudioBuffer<FloatType>(processBlockBuffer.getArrayOfWritePointers() + channelOffset, busNumChannels,
                                          processBlockBuffer.getNumSamples());
        }
        ...
        */
        ...
        inline int getMainBusNumInputChannels() const noexcept
        {
            return getChannelCountOfBus(true, 0);
        }

        /** Returns the number of output channels on the main bus. */
        inline int getMainBusNumOutputChannels() const noexcept
        {
        ...
        */
        ...
        /** Returns a string containing a whitespace-separated list of speaker types
            ...
            class.
         */
        JUCE_DEPRECATED_WITH_BODY(const String getInputSpeakerArrangement() const noexcept,
                                  { return cachedInputSpeakerArrString; })
        JUCE_DEPRECATED_WITH_BODY(const String getOutputSpeakerArrangement() const noexcept,
    ...
    protected:
        ...
        */
        ...
        struct BusesProperties
        {
            ...
            void addBus(bool isInput, const String& name, const AudioChannelSet& defaultLayout,
                        bool isActivatedByDefault = true);

            BusesProperties withInput(const String& name, const AudioChannelSet& defaultLayout,
                                      bool isActivatedByDefault = true) const;
            BusesProperties withOutput(const String& name, const AudioChannelSet& defaultLayout,
                                       bool isActivatedByDefault = true) const;
        };
    ...
    private:
        ...
        struct InOutChannelPair
        {
            ...
            InOutChannelPair(const int16 (&config)[2]) noexcept
                : inChannels(config[0])
                , outChannels(config[1])
            {
            }

            InOutChannelPair& operator=(const InOutChannelPair& o) noexcept
            {
                inChannels  = o.inChannels;
                outChannels = o.outChannels;
                return *this;
        ...
        static Array<InOutChannelPair> layoutListToArray(const short (&configuration)[numLayouts][2])
        {
            ...
            for (int i = 0; i < numLayouts; ++i) layouts.add(InOutChannelPair(configuration[i]));
        ...
        static Array<InOutChannelPair> layoutListToArray(const std::initializer_list<const short[2]>& configuration)
        {
            ...
            for (auto&& i : configuration) layouts.add(InOutChannelPair(i));
