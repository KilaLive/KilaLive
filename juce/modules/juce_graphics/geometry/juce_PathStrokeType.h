...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        void createStrokedPath(Path& destPath, const Path& sourcePath, const AffineTransform& transform = AffineTransform(),
        ...
        /** Applies this stroke type to a path, creating a dashed line.
            ...
            @param extraAccuracy    if this is greater than 1.0, it will subdivide the path to
                                    ...
                                    the stroke at 3x the size that you're creating it, you should set this to 3.
        */
        void createDashedStroke(Path& destPath, const Path& sourcePath, const float* dashLengths, int numDashLengths,
                                const AffineTransform& transform = AffineTransform(), float extraAccuracy = 1.0f) const;
        ...
        /** Applies this stroke type to a path and returns the resultant stroke as another Path.
            ...
            @see createDashedStroke
        */
        void createStrokeWithArrowheads(Path& destPath, const Path& sourcePath, float arrowheadStartWidth,
                                        float arrowheadStartLength, float arrowheadEndWidth, float arrowheadEndLength,
