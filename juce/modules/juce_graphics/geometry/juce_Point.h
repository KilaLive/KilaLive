...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        JUCE_CONSTEXPR Point(const Point& other) noexcept
            : x(other.x)
            , y(other.y)
        {
        }
        ...
        JUCE_CONSTEXPR inline bool operator==(Point other) const noexcept
        {
        ...
        JUCE_CONSTEXPR inline bool isFinite() const noexcept
        {
            return juce_isfinite(x) && juce_isfinite(y);
        }

        /** Returns the point's x coordinate. */
        JUCE_CONSTEXPR inline ValueType getX() const noexcept
        {
            return x;
        }

        /** Returns the point's y coordinate. */
        JUCE_CONSTEXPR inline ValueType getY() const noexcept
        {
            return y;
        }
        ...
        */
        FloatType getAngleToPoint(Point other) const noexcept
        {
            return static_cast<FloatType>(
                std::atan2(static_cast<FloatType>(other.x - x), static_cast<FloatType>(y - other.y)));
        }
