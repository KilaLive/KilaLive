...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        Parallelogram(Point<ValueType> topLeftPosition, Point<ValueType> topRightPosition,
        ...
        */
        ...
        {
            return topLeft + (topRight - topLeft) * relativePosition.x + (bottomLeft - topLeft) * relativePosition.y;
        }
