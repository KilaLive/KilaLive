...
namespace juce
{
    ...
    */
                    ...
                    while (--numPoints >= 0)
                    {
                        ...
                        else
                        {
                            ...
                            if (level > 0)
                            {
                                ...
                                if (numPix > 0) iterationCallback.handleEdgeTableLine(x, numPix, level);
                            }
    ...
    private:
        ...
        static void copyEdgeTableData(int* dest, int destLineStride, const int* src, int srcLineStride,
