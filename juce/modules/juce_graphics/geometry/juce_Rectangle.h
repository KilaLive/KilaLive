    ...
    public:
        ...
        */
        ...
        Rectangle(Point<ValueType> corner1, Point<ValueType> corner2) noexcept
            : pos(jmin(corner1.x, corner2.x), jmin(corner1.y, corner2.y))
        ...
        */
        ...
        {
            return pos.isFinite() && juce_isfinite(w) && juce_isfinite(h);
        }
        ...
        {
            return {pos.x + w / (ValueType)2, pos.y + h / (ValueType)2};
        }
        ...
        inline void setPosition(Point<ValueType> newPos) noexcept
        {
            pos = newPos;
        }

        /** Changes the position of the rectangle's top-left corner (leaving its size unchanged). */
        inline void setPosition(ValueType newX, ValueType newY) noexcept
        {
            pos.setXY(newX, newY);
        }
        ...
        inline void setWidth(ValueType newWidth) noexcept
        {
            w = newWidth;
        }

        /** Changes the rectangle's height */
        inline void setHeight(ValueType newHeight) noexcept
        {
            h = newHeight;
        }
        ...
        /** Changes the position of the rectangle's centre (leaving its size unchanged). */
        inline void setCentre(Point<ValueType> newCentre) noexcept
        {
        ...
        /** Returns a rectangle which has the same size and y-position as this one, but whose right-hand edge has the given
         * position. */
        ...
        /** Returns a rectangle which has the same size and x-position as this one, but whose bottom edge has the given
         * position. */
        ...
        {
            return {pos.x, pos.y, newWidth, newHeight};
        }
        ...
        {
            return {pos.x + (w - newWidth) / (ValueType)2, pos.y + (h - newHeight) / (ValueType)2, newWidth, newHeight};
        }
        ...
        */
        ...
        {
            Rectangle<FloatType>(pos.x * scaleFactor, pos.y * scaleFactor, w * scaleFactor, h * scaleFactor)
                .copyWithRounding(*this);
            return *this;
        }
        ...
        */
        ...
        {
            Rectangle<FloatType>(pos.x * scaleFactor.x, pos.y * scaleFactor.y, w * scaleFactor.x, h * scaleFactor.y)
                .copyWithRounding(*this);
            return *this;
        }
        ...
        */
        ...
        {
            return {jlimit(pos.x, pos.x + w, point.x), jlimit(pos.y, pos.y + h, point.y)};
        }
        ...
        */
        ...
        {
            return {pos.x + static_cast<ValueType>(w * relativeX), pos.y + static_cast<ValueType>(h * relativeY)};
        }
        ...
        */
        ...
        Rectangle getProportion(Rectangle<FloatType> proportionalRect) const noexcept
        {
            return {pos.x + static_cast<ValueType>(w * proportionalRect.pos.x),
                    pos.y + static_cast<ValueType>(h * proportionalRect.pos.y), proportionOfWidth(proportionalRect.w),
        ...
        {
            return pos.x <= other.pos.x && pos.y <= other.pos.y && pos.x + w >= other.pos.x + other.w
        ...
        {
            return pos.x + w > other.pos.x && pos.y + h > other.pos.y && pos.x < other.pos.x + other.w
                   && pos.y < other.pos.y + other.h && w > ValueType() && h > ValueType() && other.w > ValueType()
                   && other.h > ValueType();
        }
        ...
        */
        Rectangle getIntersection(Rectangle other) const noexcept
        {
            ...
            if (nw >= ValueType())
            {
                ...
                if (nh >= ValueType()) return {nx, ny, nw, nh};
            }
        ...
        */
        Rectangle getUnion(Rectangle other) const noexcept
        {
            ...
            return {newX, newY, jmax(pos.x + w, other.pos.x + other.w) - newX, jmax(pos.y + h, other.pos.y + other.h) - newY};
        }
        ...
        */
        Rectangle constrainedWithin(Rectangle areaToFitWithin) const noexcept
        {
            ...
            return {jlimit(areaToFitWithin.getX(), areaToFitWithin.getRight() - newW, pos.x),
                    jlimit(areaToFitWithin.getY(), areaToFitWithin.getBottom() - newH, pos.y), newW, newH};
        }
        ...
        */
        ...
        {
            return Rectangle<int>::leftTopRightBottom(floorAsInt(pos.x), floorAsInt(pos.y), ceilAsInt(pos.x + w),
                                                      ceilAsInt(pos.y + h));
        }
        ...
        */
        ...
        {
            return {roundToInt(pos.x), roundToInt(pos.y), roundToInt(w), roundToInt(h)};
        }
        ...
        */
        ...
        {
            return {static_cast<float>(pos.x), static_cast<float>(pos.y), static_cast<float>(w), static_cast<float>(h)};
        }
        ...
        */
        ...
        {
            return {static_cast<double>(pos.x), static_cast<double>(pos.y), static_cast<double>(w), static_cast<double>(h)};
        }
        ...
        */
        static bool intersectRectangles(ValueType& x1, ValueType& y1, ValueType& w1, ValueType& h1, ValueType x2,
                                        ValueType y2, ValueType w2, ValueType h2) noexcept
        {
            auto x = jmax(x1, x2);
        ...
        */
        static Rectangle fromString(StringRef stringVersion)
        {
            ...
            return {parseIntAfterSpace(toks[0]), parseIntAfterSpace(toks[1]), parseIntAfterSpace(toks[2]),
