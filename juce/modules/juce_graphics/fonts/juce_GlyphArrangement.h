...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        PositionedGlyph(const Font& font, juce_wchar character, int glyphNumber, float anchorX, float baselineY, float width,
                        bool isWhitespace);
    ...
    */
    ...
    public:
        ...
        */
        void addCurtailedLineOfText(const Font& font, const String& text, float x, float y, float maxWidthPixels,
                                    bool useEllipsis);
        ...
        */
        void addJustifiedText(const Font& font, const String& text, float x, float y, float maxLineWidth,
        ...
        */
        void addFittedText(const Font& font, const String& text, float x, float y, float width, float height,
                           Justification layout, int maximumLinesToUse, float minimumHorizontalScale = 0.0f);
        ...
        */
        void justifyGlyphs(int startIndex, int numGlyphs, float x, float y, float width, float height,
    ...
    private:
        ...
        int  fitLineIntoSpace(int start, int numGlyphs, float x, float y, float w, float h, const Font&, Justification,
                              float minimumHorizontalScale);
        void spreadOutLine(int start, int numGlyphs, float targetWidth);
        void splitLines(const String&, Font, int start, float x, float y, float w, float h, int maxLines, float lineWidth,
