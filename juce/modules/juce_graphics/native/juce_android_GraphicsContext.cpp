...
namespace juce
{
    namespace GraphicsHelpers
    {
        jobject createPaint(Graphics::ResamplingQuality quality)
        {
            ...
            if (quality > Graphics::lowResamplingQuality) constructorFlags |= 2; /*FILTER_BITMAP_FLAG*/
        ...
        const jobject createMatrix(JNIEnv* env, const AffineTransform& t)
        {
            ...
            jfloat values[9] = {t.mat00, t.mat01, t.mat02, t.mat10, t.mat11, t.mat12, 0.0f, 0.0f, 1.0f};
