...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        NormalisableRange(ValueType rangeStart, ValueType rangeEnd, ValueType intervalValue, ValueType skewFactor,
        ...
        */
        NormalisableRange(
            ...
            std::function<ValueType(ValueType currentRangeStart, ValueType currentRangeEnd, ValueType normalisedValue)>
                convertFrom0To1Func,
            std::function<ValueType(ValueType currentRangeStart, ValueType currentRangeEnd, ValueType mappedValue)>
                convertTo0To1Func,
            std::function<ValueType(ValueType currentRangeStart, ValueType currentRangeEnd, ValueType valueToSnap)>
                snapToLegalValueFunc = nullptr) noexcept
            : start(rangeStart)
            , end(rangeEnd)
        ...
        */
        ...
        {
            if (convertTo0To1Function != nullptr) return convertTo0To1Function(start, end, v);

            auto proportion = (v - start) / (end - start);

            if (skew == static_cast<ValueType>(1)) return proportion;

            if (!symmetricSkew) return std::pow(proportion, skew);
            ...
            return (static_cast<ValueType>(1)
                    + std::pow(std::abs(distanceFromMiddle), skew)
                          * (distanceFromMiddle < ValueType() ? static_cast<ValueType>(-1) : static_cast<ValueType>(1)))
        ...
        */
        ...
        {
            if (convertFrom0To1Function != nullptr) return convertFrom0To1Function(start, end, proportion);
        ...
        */
        ...
        {
            if (snapToLegalValueFunction != nullptr) return snapToLegalValueFunction(start, end, v);
    ...
    private:
        ...
        ConverstionFunction convertFrom0To1Function = {}, convertTo0To1Function = {}, snapToLegalValueFunction = {};
    };
