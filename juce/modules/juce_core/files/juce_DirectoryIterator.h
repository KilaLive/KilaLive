...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        DirectoryIterator(const File& directory, bool isRecursive, const String& wildCard = "*",
    ...
    private:
        ...
        public:
            ...
            bool next(String& filenameFound, bool* isDirectory, bool* isHidden, int64* fileSize, Time* modTime,
