    ...
    public:
        ...
        */
        int size() const noexcept
        {
            ...
            for (auto* i = item; i != nullptr; i = i->nextListItem) ++total;
        ...
        */
        LinkedListPointer& operator[](int index) noexcept
        {
            ...
            while (--index >= 0 && l->item != nullptr) l = &(l->item->nextListItem);
        ...
        */
        ...
        bool contains(const ObjectType* const itemToLookFor) const noexcept
        {
            for (auto* i = item; i != nullptr; i = i->nextListItem)
                if (itemToLookFor == i) return true;
        ...
        */
        ...
        {
            if (auto* l = findPointerTo(itemToRemove)) l->removeNext();
        }
        ...
        */
        LinkedListPointer* findPointerTo(ObjectType* const itemToLookFor) noexcept
        {
            ...
            {
                if (l->item == itemToLookFor) return l;
        ...
        */
        void copyToArray(ObjectType** destArray) const noexcept
        {
            ...
            for (auto* i = item; i != nullptr; i = i->nextListItem) *destArray++ = i;
        }
