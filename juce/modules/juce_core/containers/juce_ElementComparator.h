...
namespace juce
{
    ...
    */
    ...
    static void sortArray(ElementComparator& comparator, ElementType* const array, int firstElement, int lastElement,
    ...
    */
    template <class ElementType, class ElementComparator>
    static int findInsertIndexInSortedArray(ElementComparator& comparator, ElementType* const array,
                                            const ElementType newElement, int firstElement, int lastElement)
    {
        ...
        while (firstElement < lastElement)
        {
            ...
            else
            {
                ...
                {
                    if (comparator.compareElements(newElement, array[halfway]) >= 0) ++firstElement;
