    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            for (Iterator<DummyBailOutChecker, ThisType> iter(*this); iter.next();) callback(*iter.getListener());
        }
        ...
        */
        ...
        void callExcluding(ListenerClass* listenerToExclude, Callback&& callback)
        {
            for (Iterator<DummyBailOutChecker, ThisType> iter(*this); iter.next();)
            {
                ...
                if (l != listenerToExclude) callback(*l);
            }
        }
        ...
        */
        template <typename Callback, typename BailOutCheckerType>
        void callCheckedExcluding(ListenerClass* listenerToExclude, const BailOutCheckerType& bailOutChecker,
                                  Callback&& callback)
        {
            for (Iterator<BailOutCheckerType, ThisType> iter(*this); iter.next(bailOutChecker);)
            {
        ...
        */
        ...
        void call(void (ListenerClass::*callbackFunction)(MethodArgs...), Args&&... args)
        {
            for (Iterator<DummyBailOutChecker, ThisType> iter(*this); iter.next();)
                (iter.getListener()->*callbackFunction)(
                    static_cast<typename TypeHelpers::ParameterType<Args>::type>(args)...);
        }

        template <typename... MethodArgs, typename... Args>
        void callExcluding(ListenerClass* listenerToExclude, void (ListenerClass::*callbackFunction)(MethodArgs...),
                           Args&&... args)
        {
            for (Iterator<DummyBailOutChecker, ThisType> iter(*this); iter.next();)
        ...
        void callChecked(const BailOutCheckerType& bailOutChecker, void (ListenerClass::*callbackFunction)(MethodArgs...),
                         Args&&... args)
        {
            for (Iterator<BailOutCheckerType, ThisType> iter(*this); iter.next(bailOutChecker);)
                (iter.getListener()->*callbackFunction)(
