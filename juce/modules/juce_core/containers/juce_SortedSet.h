    ...
    */
    ...
    public:
        ...
        SortedSet(SortedSet&& other) noexcept
            : data(static_cast<decltype(data)&&>(other.data))
        {
        }
        ...
        */
        int indexOf(const ElementType& elementToLookFor) const noexcept
        {
            ...
            for (;;)
            {
                ...
                if (elementToLookFor == data.getReference(s)) return s;
        ...
        */
        void addArray(const ElementType* elementsToAdd, int numElementsToAdd) noexcept
        {
            ...
            while (--numElementsToAdd >= 0) add(*elementsToAdd++);
        }
        ...
        */
        ...
        void addSet(const OtherSetType& setToAddFrom, int startIndex = 0, int numElementsToAdd = -1) noexcept
        {
            ...
            if (this != &setToAddFrom)
            {
                ...
                if (numElementsToAdd > 0) addArray(&setToAddFrom.data.getReference(startIndex), numElementsToAdd);
            }
        }
        ...
        void removeValuesIn(const OtherSetType& otherSet) noexcept
        {
            ...
            else if (!otherSet.isEmpty())
            {
                for (int i = data.size(); --i >= 0;)
                    if (otherSet.contains(data.getReference(i))) remove(i);
            }
        }
