...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        ...
        void clear(bool deleteObjects = true)
        {
            ...
            if (deleteObjects) deleteAllObjects();
        ...
        */
        void insertArray(int indexToInsertAt, ObjectClass* const* newObjects, int numberOfElements)
        {
            if (numberOfElements > 0)
            {
                ...
                while (--numberOfElements >= 0) *insertPos++ = *newObjects++;
            }
        }
...

                {
                    ...
                    if (indexToChange < numUsed)
                    {
                        if (deleteOldElement)
                        {
                            ...
                            if (toDelete.get() == newObject) toDelete.release();
                        }
        ...
        void remove(int indexToRemove, bool deleteObject = true)
        {
...

            {
                ...
                if (isPositiveAndBelow(indexToRemove, numUsed))
                {
                    ...
                    if (deleteObject) toDelete.reset(*e);

                    --numUsed;
                    auto numToShift = numUsed - indexToRemove;

                    if (numToShift > 0) memmove(e, e + 1, sizeof(ObjectClass*) * (size_t)numToShift);
                }
            }
    ...
    private:
        ...
        {
            while (numUsed > 0) ContainerDeletePolicy<ObjectClass>::destroy(data.elements[--numUsed]);
        }
