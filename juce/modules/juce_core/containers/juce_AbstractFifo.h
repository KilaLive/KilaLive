    ...
    public:
        ...
        */
        ...
        /** Returns the location within the buffer at which an incoming block of data should be written.
            ...
            @param startIndex1      on exit, this will contain the start index in your buffer at which your data should be
           written
            @param blockSize1       on exit, this indicates how many items can be written to the block starting at startIndex1
            @param startIndex2      on exit, this will contain the start index in your buffer at which any data that didn't
           fit into the first block should be written
        ...
        */
        ...
        /** Returns the location within the buffer from which the next block of data should be read.
           ...
           fit into the first block should be written
            ...
            @see finishedRead
        */
        void prepareToRead(int numWanted, int& startIndex1, int& blockSize1, int& startIndex2, int& blockSize2) const
            noexcept;
