    ...
    */
    ...
    public:
        ...
        */
        Array(const Array<ElementType, TypeOfCriticalSectionToUse>& other)
        {
            ...
            for (int i = 0; i < numUsed; ++i) new (data.elements + i) ElementType(other.data.elements[i]);
        }
        ...
        */
        ...
        {
            while (*values != TypeToCreateFrom()) add(*values++);
        }
        ...
        */
            ...
            : numUsed(numValues)
        {
            ...
            for (int i = 0; i < numValues; ++i) new (data.elements + i) ElementType(values[i]);
        }
        ...
        */
        ...
        bool operator==(const OtherArrayType& other) const
        {
            ...
            if (numUsed != other.numUsed) return false;

            for (int i = numUsed; --i >= 0;)
                if (!(data.elements[i] == other.data.elements[i])) return false;
        ...
        */
        int indexOf(ParameterType elementToLookFor) const
        {
            ...
            for (; e != endPtr; ++e)
                if (elementToLookFor == *e) return static_cast<int>(e - data.elements.get());
        ...
        */
        void insert(int indexToInsertAt, ParameterType newElement)
        {
            ...
            if (isPositiveAndBelow(indexToInsertAt, numUsed))
            {
                ...
                if (numberToMove > 0) memmove(insertPos + 1, insertPos, ((size_t)numberToMove) * sizeof(ElementType));
        ...
        */
        void insertArray(int indexToInsertAt, const ElementType* newElements, int numberOfElements)
        {
            if (numberOfElements > 0)
            {
                ...
                while (--numberOfElements >= 0) new (insertPos++) ElementType(*newElements++);
            }
        }
        ...
        */
        ...
        void addArray(const OtherArrayType& arrayToAddFrom, int startIndex = 0, int numElementsToAdd = -1)
        {
...

            {
                ...
                while (--numElementsToAdd >= 0) addAssumingCapacityIsReady(arrayToAddFrom.getUnchecked(startIndex++));
            }
        }
        ...
        */
        ...
        int indexOfSorted(ElementComparator& comparator, TargetValueType elementToLookFor) const
        {
            ...
            for (int s = 0, e = numUsed;;)
            {
                ...
                if (comparator.compareElements(elementToLookFor, data.elements[s]) == 0) return s;
        ...
        */
        void removeRange(int startIndex, int numberToRemove)
        {
            ...
            if (endIndex > startIndex)
            {
                ...
                for (int i = 0; i < numberToRemove; ++i) e[i].~ElementType();

                auto numToShift = numUsed - endIndex;

                if (numToShift > 0) memmove(e, e + numberToRemove, ((size_t)numToShift) * sizeof(ElementType));
        ...
        */
        void removeLast(int howManyToRemove = 1)
        {
            ...
            if (howManyToRemove > numUsed) howManyToRemove = numUsed;

            for (int i = 1; i <= howManyToRemove; ++i) data.elements[numUsed - i].~ElementType();
        ...
        */
        ...
        void removeValuesIn(const OtherArrayType& otherArray)
        {
            ...
            else
            {
                ...
                {
                    for (int i = numUsed; --i >= 0;)
                        if (otherArray.contains(data.elements[i])) removeInternal(i);
                }
            }
        }
        ...
        */
        void swap(int index1, int index2)
        {
            ...
            {
                std::swap(data.elements[index1], data.elements[index2]);
            }
        }
        ...
        void move(int currentIndex, int newIndex) noexcept
        {
            if (currentIndex != newIndex)
            {
                ...
                if (isPositiveAndBelow(currentIndex, numUsed))
                {
                    ...
                    {
                        memmove(data.elements + currentIndex, data.elements + currentIndex + 1,
                                sizeof(ElementType) * (size_t)(newIndex - currentIndex));
                    }
                    else
                    {
                        memmove(data.elements + newIndex + 1, data.elements + newIndex,
    ...
    private:
        ...
        void removeInternal(const int indexToRemove)
        {
            ...
            if (numberToShift > 0) memmove(e, e + 1, ((size_t)numberToShift) * sizeof(ElementType));
        ...
        {
            for (int i = 0; i < numUsed; ++i) data.elements[i].~ElementType();
        }
        ...
        void addAssumingCapacityIsReady(const ElementType& e)
        {
            new (data.elements + numUsed++) ElementType(e);
        }
        void addAssumingCapacityIsReady(ElementType&& e)
        {
            new (data.elements + numUsed++) ElementType(static_cast<ElementType&&>(e));
        }
