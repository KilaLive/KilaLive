...
#pragma warning(pop)
    ...
    {
        if (c < 0x80 || c >= 0xa0) return (juce_wchar)c;
...
#define STRING_DOUBLE_PAIR_COMBOS(value)                                                                                     \
    STRING_DOUBLE_PAIR(value), STRING_DOUBLE_PAIR(-value), ASYM_STRING_DOUBLE_PAIR(+value, value),                           \
        ASYM_STRING_DOUBLE_PAIR(000000##value, value), ASYM_STRING_DOUBLE_PAIR(+000##value, value),                          \
    ...
    public:
        CharacterFunctionsTests()
            : UnitTest("CharacterFunctions", "Text")
        {
        }
