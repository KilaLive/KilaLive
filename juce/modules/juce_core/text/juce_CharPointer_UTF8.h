    ...
    */
    ...
    public:
        ...
        juce_wchar operator*() const noexcept
        {
            ...
            if (byte >= 0) return (juce_wchar)(uint8)byte;
        ...
        void write(const juce_wchar charToWrite) noexcept
        {
            ...
            if (c >= 0x80)
            {
                ...
                *data++ = (CharType)((uint32)(0xff << (7 - numExtraBytes)) | (c >> (numExtraBytes * 6)));
                ...
                while (--numExtraBytes >= 0) *data++ = (CharType)(0x80 | (0x3f & (c >> (numExtraBytes * 6))));
            }
            else
            {
                *data++ = (CharType)c;
        ...
        */
        static bool isByteOrderMark(const void* possibleByteOrder) noexcept
        {
            ...
            return c[0] == (uint8)byteOrderMark1 && c[1] == (uint8)byteOrderMark2 && c[2] == (uint8)byteOrderMark3;
        }
