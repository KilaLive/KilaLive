...
namespace juce
{
    struct TextDiffHelpers
    {
                                              ...
                                              String::CharPointerType b, const int lenB, int& indexInB) noexcept
        {
            ...
            if (lenA * lenB > maxComplexity) return findCommonSuffix(a, lenA, indexInA, b, lenB, indexInB);
                                              ...
                                              const size_t scratchSpace, int* const lines) noexcept
        {
            ...
            for (int i = 0; i < lenA; ++i)
            {
                ...
                if (++loopsWithoutImprovement > 100) break;
        ...
        static int findCommonSuffix(String::CharPointerType a, int lenA, int& indexInA, String::CharPointerType b, int lenB,
    ...
    {
        for (auto& c : changes) text = c.appliedTo(text);
