    ...
    public:
        ...
        */
        ...
        static double readDoubleValue(CharPointerType& text) noexcept
        {
            ...
            if (decPointIndex != 0) result[1] = mulexp10(result[1], exponentAccumulator[1]) + accumulator[1];
            ...
            for (;;)
            {
                if (text.isDigit())
                {
                    ...
                    if (numSigFigs >= maxSignificantDigits || ((numSigFigs == 0 && (!decimalPointFound)) && digit == 0))
                        continue;
            ...
            if ((c == 'e' || c == 'E') && numSigFigs > 0)
            {
                *currentCharacter++ = 'e';
                ...
                while (text.isDigit())
                {
                    if (currentCharacter == &buffer[bufferSize - 1]) return std::numeric_limits<double>::quiet_NaN();
                ...
                if (exponentMagnitude == 0) *currentCharacter++ = '0';
            }
        ...
        struct HexParser
        {
            ...
            static ResultType parse(CharPointerType t) noexcept
            {
                ...
                while (!t.isEmpty())
                {
                    ...
                    if (hexValue >= 0) result = (result << 4) | hexValue;
                }
