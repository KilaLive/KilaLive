...
#error "The JUCE_ANDROID_ACTIVITY_CLASSNAME and JUCE_ANDROID_ACTIVITY_CLASSPATH macros must be set!"
    ...
    public:
        ...
        inline explicit GlobalRef(jobject o)
            : obj(retain(o))
        {
        }
        ...
        inline GlobalRef(GlobalRef&& other) noexcept
            : obj(0)
        {
...
#undef DECLARE_CALL_TYPE_METHOD
    ...
    {
    public:
        explicit inline LocalRef() noexcept
            : obj(0)
        {
        }
        ...
        inline LocalRef(LocalRef&& other) noexcept
            : obj(0)
        {
            std::swap(obj, other.obj);
        }
...
#define JUCE_JNI_CALLBACK(className, methodName, returnType, params)                                                         \
    extern "C" __attribute__((visibility("default")))                                                                        \
        JUCE_ARM_SOFT_FLOAT_ABI returnType JUCE_JOIN_MACRO(JUCE_JOIN_MACRO(Java_, className), _##methodName) params
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD)                                                          \
    ...
    STATICMETHOD(createHTTPStream, "createHTTPStream",                                                                       \
                 "(Ljava/lang/String;Z[BLjava/lang/String;I[ILjava/lang/StringBuffer;ILjava/lang/"                           \
                 "String;)L" JUCE_ANDROID_ACTIVITY_CLASSPATH "$HTTPStream;")                                                 \
    METHOD(launchURL, "launchURL", "(Ljava/lang/String;)V")                                                                  \
    METHOD(showMessageBox, "showMessageBox", "(Ljava/lang/String;Ljava/lang/String;J)V")                                     \
    METHOD(showOkCancelBox, "showOkCancelBox",                                                                               \
    ...
    METHOD(getAndroidMidiDeviceManager, "getAndroidMidiDeviceManager",                                                       \
           "()L" JUCE_ANDROID_ACTIVITY_CLASSPATH "$MidiDeviceManager;")                                                      \
    METHOD(getAndroidBluetoothManager, "getAndroidBluetoothManager",                                                         \
           "()L" JUCE_ANDROID_ACTIVITY_CLASSPATH "$BluetoothManager;")                                                       \
