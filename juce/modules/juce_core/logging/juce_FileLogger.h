...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        static FileLogger* createDefaultAppLogger(const String& logFileSubDirectoryName, const String& logFileName,
        ...
        /** Helper function to create a log file in the correct place for this platform.
            ...
            @param welcomeMessage               a message that will be written to the log when it's opened.
        */
        static FileLogger* createDateStampedLogger(const String& logFileSubDirectoryName, const String& logFileNameRoot,
