...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        static String JUCE_CALLTYPE getValue(const String& regValuePath, const String& defaultValue = String(),
        ...
        */
        static uint32 JUCE_CALLTYPE getBinaryValue(const String& regValuePath, MemoryBlock& resultData,
                                                   WoW64Mode mode = WoW64_Default);
        ...
        */
        ...
        /** Sets a registry value as a binary block.
            This will take care of creating any groups needed to get to the given registry value.
        */
        static bool JUCE_CALLTYPE setValue(const String& regValuePath, const MemoryBlock& value,
                                           WoW64Mode mode = WoW64_Default);
        ...
        */
        static bool JUCE_CALLTYPE registerFileAssociation(const String& fileExtension, const String& symbolicDescription,
