...
namespace juce
{
    ...
    int64 InputStream::readInt64()
    {
        ...
        if (read(n.asBytes, 8) == 8) return (int64)ByteOrder::swapIfBigEndian(n.asInt64);
    ...
    int64 InputStream::readInt64BigEndian()
    {
        ...
        if (read(n.asBytes, 8) == 8) return (int64)ByteOrder::swapIfLittleEndian(n.asInt64);
