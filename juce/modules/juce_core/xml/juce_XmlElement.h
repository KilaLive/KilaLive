...
#define forEachXmlChildElement(parentXmlElement, childElementVariableName)                                                   \
                                                                                                                             \
    for (auto* childElementVariableName = (parentXmlElement).getFirstChildElement(); childElementVariableName != nullptr;    \
...
#define forEachXmlChildElementWithTagName(parentXmlElement, childElementVariableName, requiredTagName)                       \
    ...
    */
    ...
    public:
        ...
        */
        String createDocument(StringRef dtdToUse, bool allOnOneLine = false, bool includeXmlHeader = true,
        ...
        */
        void writeToStream(OutputStream& output, StringRef dtdToUse, bool allOnOneLine = false, bool includeXmlHeader = true,
                           StringRef encodingType = "UTF-8", int lineWrapLength = 60) const;
        ...
        /** Writes the element to a file as an XML document.
            ...
            @see createDocument
        */
        bool writeToFile(const File& destinationFile, StringRef dtdToUse, StringRef encodingType = "UTF-8",
        ...
        */
        bool compareAttribute(StringRef attributeName, StringRef stringToCompareAgainst, bool ignoreCase = false) const
            noexcept;
