    ...
    */
    ...
    public:
        ...
        */
        ...
        IPAddress(uint16 address1, uint16 address2, uint16 address3, uint16 address4, uint16 address5, uint16 address6,
                  uint16 address7, uint16 address8) noexcept;
    ...
    private:
        ...
        {
            for (int i = 4; i < 16; ++i) address[i] = 0;
        }
    };
