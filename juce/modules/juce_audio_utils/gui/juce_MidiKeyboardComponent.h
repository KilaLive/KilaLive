...
namespace juce
{
    ...
    */
    ...
    protected:
        ...
        */
        virtual void drawWhiteNote(int midiNoteNumber, Graphics& g, Rectangle<float> area, bool isDown, bool isOver,
        ...
        /** Draws a black note in the given rectangle.
            ...
            When doing this, be sure to note the keyboard's orientation.
        */
        virtual void drawBlackNote(int midiNoteNumber, Graphics& g, Rectangle<float> area, bool isDown, bool isOver,
    ...
    private:
        ...
        virtual int getKeyPosition(int, float, int&, int&) const
        {
            return 0;
        }
        virtual int drawWhiteNote(int, Graphics&, int, int, int, int, bool, bool, const Colour&, const Colour&)
        {
            return 0;
        }
        virtual int drawBlackNote(int, Graphics&, int, int, int, int, bool, bool, const Colour&)
        {
            return 0;
        }
#endif
