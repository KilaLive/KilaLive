...
namespace juce
{
    ...
    */
    ...
    public:
        ...
        */
        virtual void drawChannel(Graphics& g, const Rectangle<int>& area, double startTimeSeconds, double endTimeSeconds,
                                 int channelNum, float verticalZoomFactor) = 0;
        ...
        /** Draws the waveforms for all channels in the thumbnail.
            ...
            @see drawChannel
        */
        virtual void drawChannels(Graphics& g, const Rectangle<int>& area, double startTimeSeconds, double endTimeSeconds,
        ...
        */
        virtual void getApproximateMinMax(double startTime, double endTime, int channelIndex, float& minValue,
