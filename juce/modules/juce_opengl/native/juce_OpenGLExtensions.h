...
#define JUCE_GL_BASE_FUNCTIONS(USE_FUNCTION)                                                                                 \
    ...
    USE_FUNCTION(glVertexAttribPointer, void, (GLuint p1, GLint p2, GLenum p3, GLboolean p4, GLsizei p5, const GLvoid* p6),  \
                 (p1, p2, p3, p4, p5, p6))                                                                                   \
...
#elif JUCE_LINUX
#define JUCE_DECLARE_GL_FUNCTION(name, returnType, params, callparams)                                                       \
    typedef returnType(*type_##name) params;                                                                                 \
    type_##name name;
        JUCE_GL_BASE_FUNCTIONS(JUCE_DECLARE_GL_FUNCTION)
        JUCE_GL_EXTENSION_FUNCTIONS(JUCE_DECLARE_GL_FUNCTION)
#if JUCE_OPENGL3
...
#else
#define JUCE_DECLARE_GL_FUNCTION(name, returnType, params, callparams)                                                       \
    inline static returnType name params noexcept                                                                            \
    {                                                                                                                        \
        return ::name callparams;                                                                                            \
    }
        JUCE_GL_BASE_FUNCTIONS(JUCE_DECLARE_GL_FUNCTION)
