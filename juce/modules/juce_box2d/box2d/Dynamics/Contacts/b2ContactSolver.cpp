...
void b2ContactSolver::SolveVelocityConstraints()
{
    for (int32 i = 0; i < m_count; ++i)
    {
        ...
        else
        {
            ...
            // vn1 = 0 and vn2 = 0, x1 = 0 and x2 = 0, x1 = 0 and vn2 = 0, x2 = 0 and vn1 = 0 need to be tested. The first
            ...
            // requires that the accumulated impulse is clamped and not the incremental impulse) we change the impulse
            // variable (x_i).
            //
            // Substitute:
            //
